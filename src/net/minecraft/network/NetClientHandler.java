...
public class NetClientHandler extends NetHandler {
	...
	public void handleLogin(Packet1Login var1) {
		...
		this.mc.displayGuiScreen(new net.minecraft.client.render.gui.GuiDownloadTerrain(this));
	...
	public void handleVehicleSpawn(Packet23VehicleSpawn var1) {
		...
		Object var8 = null;
		if(var1.type == 10) {
			var8 = new net.minecraft.entity.EntityMinecart(this.worldClient, var2, var4, var6, 0);
		}

		if(var1.type == 11) {
			var8 = new net.minecraft.entity.EntityMinecart(this.worldClient, var2, var4, var6, 1);
		}
		...
		if(var8 != null) {
			((net.minecraft.entity.Entity)var8).serverPosX = var1.xPosition;
			((net.minecraft.entity.Entity)var8).serverPosY = var1.yPosition;
			((net.minecraft.entity.Entity)var8).serverPosZ = var1.zPosition;
			((net.minecraft.entity.Entity)var8).rotationYaw = 0.0F;
			((net.minecraft.entity.Entity)var8).rotationPitch = 0.0F;
			((net.minecraft.entity.Entity)var8).entityId = var1.entityId;
			this.worldClient.func_712_a(var1.entityId, (net.minecraft.entity.Entity)var8);
			if(var1.field_28044_i > 0) {
				...
				((net.minecraft.entity.Entity)var8).setVelocity((double)var1.field_28047_e / 8000.0D, (double)var1.field_28046_f / 8000.0D, (double)var1.field_28045_g / 8000.0D);
			}
		}
	...
	public void handleWeather(Packet71Weather var1) {
		...
		net.minecraft.entity.EntityLightningBolt var8 = null;
	...
	public void func_21146_a(Packet25EntityPainting var1) {
		net.minecraft.entity.EntityPainting var2 = new EntityPainting(this.worldClient, var1.xPosition, var1.yPosition, var1.zPosition, var1.direction, var1.title);
	...
	public void handleKickDisconnect(Packet255KickDisconnect var1) {
		...
		this.mc.changeWorld1((net.minecraft.world.World)null);
		this.mc.displayGuiScreen(new net.minecraft.client.render.gui.GuiConnectFailed("disconnect.disconnected", "disconnect.genericReason", new Object[]{var1.reason}));
	}
	...
	public void handleCollect(Packet22Collect var1) {
		...
		if(var2 != null) {
			...
			this.mc.effectRenderer.addEffect(new EntityPickupFX(this.mc.theWorld, var2, (net.minecraft.entity.Entity)var3, -0.5F));
	...
	public void func_6497_a(Packet39AttachEntity var1) {
		...
		net.minecraft.entity.Entity var3 = this.getEntityByID(var1.vehicleEntityId);
		if(var1.entityId == this.mc.thePlayer.entityId) {
			var2 = this.mc.thePlayer;
		}

		if(var2 != null) {
			((net.minecraft.entity.Entity)var2).mountEntity(var3);
		}
	}
	...
	private net.minecraft.entity.Entity getEntityByID(int var1) {
		return (net.minecraft.entity.Entity)(var1 == this.mc.thePlayer.entityId ? this.mc.thePlayer : this.worldClient.func_709_b(var1));
	}
