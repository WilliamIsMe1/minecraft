...
public class EntityPickupFX extends EntityFX {
	private net.minecraft.entity.Entity field_675_a;
	private net.minecraft.entity.Entity field_679_o;
	private int field_678_p = 0;
	private int field_677_q = 0;
	private float field_676_r;

	public EntityPickupFX(World var1, net.minecraft.entity.Entity var2, Entity var3, float var4) {
