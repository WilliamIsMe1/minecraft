...
public class EntitySnowball extends net.minecraft.entity.Entity {
	...
	private net.minecraft.entity.EntityLiving thrower;
	private int ticksInGroundSnowball;
	private int ticksInAirSnowball = 0;

	public EntitySnowball(net.minecraft.world.World var1) {
		super(var1);
	...
	public EntitySnowball(net.minecraft.world.World var1, EntityLiving var2) {
		super(var1);
		this.thrower = var2;
		this.setSize(0.25F, 0.25F);
