...
public class Pathfinder {
	...
	private final PathPoint openPoint(int var1, int var2, int var3) {
		int var4 = PathPoint.hash(var1, var2, var3);
		...
		for(int var6 = var2; var6 < var2 + var5.xCoord; ++var6) {
			for(int var7 = var3; var7 < var3 + var5.yCoord; ++var7) {
				for(int var8 = var4; var8 < var4 + var5.zCoord; ++var8) {
					...
					if(var9 > 0) {
						if(var9 != net.minecraft.block.Block.doorSteel.blockID && var9 != net.minecraft.block.Block.doorWood.blockID) {
							net.minecraft.block.Material var11 = Block.blocksList[var9].blockMaterial;
							if(var11.getIsSolid()) {
								return 0;
							}

							if(var11 == net.minecraft.block.Material.water) {
								return -1;
							}
