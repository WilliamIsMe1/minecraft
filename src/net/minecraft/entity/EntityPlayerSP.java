...
public class EntityPlayerSP extends EntityPlayer {
	...
	private net.minecraft.client.MouseFilter field_21903_bJ = new net.minecraft.client.MouseFilter();
	private net.minecraft.client.MouseFilter field_21904_bK = new net.minecraft.client.MouseFilter();
	private net.minecraft.client.MouseFilter field_21902_bL = new net.minecraft.client.MouseFilter();
	...
	public void onLivingUpdate() {
		if(!this.mc.statFileWriter.hasAchievementUnlocked(net.minecraft.achievement.AchievementList.openInventory)) {
		...
		if(this.inPortal) {
			if(!this.worldObj.multiplayerWorld && this.ridingEntity != null) {
				this.mountEntity((net.minecraft.entity.Entity)null);
			}

			if(this.mc.currentScreen != null) {
				this.mc.displayGuiScreen((net.minecraft.client.render.gui.GuiScreen)null);
			}
	...
	public void displayGUIEditSign(TileEntitySign var1) {
		this.mc.displayGuiScreen(new net.minecraft.client.render.gui.GuiEditSign(var1));
	}

	public void displayGUIChest(IInventory var1) {
		this.mc.displayGuiScreen(new net.minecraft.client.render.gui.GuiChest(this.inventory, var1));
	}

	public void displayWorkbenchGUI(int var1, int var2, int var3) {
		this.mc.displayGuiScreen(new net.minecraft.client.render.gui.GuiCrafting(this.inventory, this.worldObj, var1, var2, var3));
	}

	public void displayGUIFurnace(TileEntityFurnace var1) {
		this.mc.displayGuiScreen(new net.minecraft.client.render.gui.GuiFurnace(this.inventory, var1));
	}

	public void displayGUIDispenser(TileEntityDispenser var1) {
		this.mc.displayGuiScreen(new net.minecraft.client.render.gui.GuiDispenser(this.inventory, var1));
	}
	...
	public void addStat(StatBase var1, int var2) {
		if(var1 != null) {
			if(var1.func_25067_a()) {
				net.minecraft.achievement.Achievement var3 = (net.minecraft.achievement.Achievement)var1;
