...
public class EntitySkeleton extends EntityMob {
	private static final net.minecraft.item.ItemStack defaultHeldItem = new net.minecraft.item.ItemStack(net.minecraft.item.Item.bow, 1);
	...
	protected int getDropItemId() {
		return net.minecraft.item.Item.arrow.shiftedIndex;
	}
	...
	protected void dropFewItems() {
		...
		for(var2 = 0; var2 < var1; ++var2) {
			this.dropItem(net.minecraft.item.Item.arrow.shiftedIndex, 1);
		}
