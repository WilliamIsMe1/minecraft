...
public class EntityEgg extends net.minecraft.entity.Entity {
	...
	private net.minecraft.entity.EntityLiving field_20051_g;
	private int field_20050_h;
	private int field_20049_i = 0;

	public EntityEgg(net.minecraft.world.World var1) {
		super(var1);
	...
	public EntityEgg(net.minecraft.world.World var1, EntityLiving var2) {
		super(var1);
