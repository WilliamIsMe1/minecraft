...
public class EntityClientPlayerMP extends EntityPlayerSP {
	public net.minecraft.network.NetClientHandler sendQueue;
	...
	public void func_4056_N() {
		...
		if(var1 != this.wasSneaking) {
			if(var1) {
				this.sendQueue.addToSendQueue(new net.minecraft.network.Packet19EntityAction(this, 1));
			} else {
				this.sendQueue.addToSendQueue(new net.minecraft.network.Packet19EntityAction(this, 2));
			}
		...
		if(this.ridingEntity != null) {
			if(var15) {
				this.sendQueue.addToSendQueue(new net.minecraft.network.Packet11PlayerPosition(this.motionX, -999.0D, -999.0D, this.motionZ, this.onGround));
			} else {
				this.sendQueue.addToSendQueue(new net.minecraft.network.Packet13PlayerLookMove(this.motionX, -999.0D, -999.0D, this.motionZ, this.rotationYaw, this.rotationPitch, this.onGround));
			}

			var14 = false;
		} else if(var14 && var15) {
			this.sendQueue.addToSendQueue(new net.minecraft.network.Packet13PlayerLookMove(this.posX, this.boundingBox.minY, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround));
			this.field_12242_bI = 0;
		} else if(var14) {
			this.sendQueue.addToSendQueue(new net.minecraft.network.Packet11PlayerPosition(this.posX, this.boundingBox.minY, this.posY, this.posZ, this.onGround));
			this.field_12242_bI = 0;
		} else if(var15) {
			this.sendQueue.addToSendQueue(new net.minecraft.network.Packet12PlayerLook(this.rotationYaw, this.rotationPitch, this.onGround));
			this.field_12242_bI = 0;
		} else {
			this.sendQueue.addToSendQueue(new net.minecraft.network.Packet10Flying(this.onGround));
	...
	public void dropCurrentItem() {
		this.sendQueue.addToSendQueue(new net.minecraft.network.Packet14BlockDig(4, 0, 0, 0, 0));
	}
	...
	public void sendChatMessage(String var1) {
		this.sendQueue.addToSendQueue(new net.minecraft.network.Packet3Chat(var1));
	}

	public void swingItem() {
		super.swingItem();
		this.sendQueue.addToSendQueue(new net.minecraft.network.Packet18Animation(this, 1));
	}

	public void respawnPlayer() {
		this.sendInventoryChanged();
		this.sendQueue.addToSendQueue(new net.minecraft.network.Packet9Respawn((byte)this.dimension));
	}
