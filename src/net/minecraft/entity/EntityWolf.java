...
public class EntityWolf extends EntityAnimal {
	...
	protected void updatePlayerActionState() {
		...
		if(!this.hasAttacked && !this.hasPath() && this.isWolfTamed() && this.ridingEntity == null) {
			net.minecraft.entity.EntityPlayer var3 = this.worldObj.getPlayerEntityByName(this.getWolfOwner());
			if(var3 != null) {
			...
			if(!var1.isEmpty()) {
				this.setTarget((net.minecraft.entity.Entity)var1.get(this.worldObj.rand.nextInt(var1.size())));
			}
		}
	...
	public void onLivingUpdate() {
		...
		if(this.hasCurrentTarget() && !this.hasPath() && !this.isWolfAngry()) {
			net.minecraft.entity.Entity var1 = this.getCurrentTarget();
			if(var1 instanceof net.minecraft.entity.EntityPlayer) {
				net.minecraft.entity.EntityPlayer var2 = (net.minecraft.entity.EntityPlayer)var1;
				net.minecraft.item.ItemStack var3 = var2.inventory.getCurrentItem();
				if(var3 != null) {
					if(!this.isWolfTamed() && var3.itemID == net.minecraft.item.Item.bone.shiftedIndex) {
						this.looksWithInterest = true;
					} else if(this.isWolfTamed() && net.minecraft.item.Item.itemsList[var3.itemID] instanceof net.minecraft.item.ItemFood) {
						this.looksWithInterest = ((net.minecraft.item.ItemFood) net.minecraft.item.Item.itemsList[var3.itemID]).getIsWolfsFavoriteMeat();
					}
				}
			}
		}
	...
	public boolean attackEntityFrom(net.minecraft.entity.Entity var1, int var2) {
		this.setWolfSitting(false);
		if(var1 != null && !(var1 instanceof net.minecraft.entity.EntityPlayer) && !(var1 instanceof EntityArrow)) {
			var2 = (var2 + 1) / 2;
		}

		if(!super.attackEntityFrom((net.minecraft.entity.Entity)var1, var2)) {
			return false;
		} else {
			if(!this.isWolfTamed() && !this.isWolfAngry()) {
				if(var1 instanceof net.minecraft.entity.EntityPlayer) {
					this.setWolfAngry(true);
					this.playerToAttack = (net.minecraft.entity.Entity)var1;
				}
				...
				if(var1 instanceof EntityLiving) {
					...
					while(var4.hasNext()) {
						...
						if(!var6.isWolfTamed() && var6.playerToAttack == null) {
							var6.playerToAttack = (net.minecraft.entity.Entity)var1;
							if(var1 instanceof net.minecraft.entity.EntityPlayer) {
				...
				if(this.isWolfTamed() && var1 instanceof net.minecraft.entity.EntityPlayer && ((net.minecraft.entity.EntityPlayer)var1).username.equalsIgnoreCase(this.getWolfOwner())) {
					return true;
				}
	...
	public boolean interact(EntityPlayer var1) {
		...
		if(!this.isWolfTamed()) {
			if(var2 != null && var2.itemID == net.minecraft.item.Item.bone.shiftedIndex && !this.isWolfAngry()) {
				--var2.stackSize;
				if(var2.stackSize <= 0) {
					var1.inventory.setInventorySlotContents(var1.inventory.currentItem, (net.minecraft.item.ItemStack)null);
				}
			...
			if(var2 != null && net.minecraft.item.Item.itemsList[var2.itemID] instanceof net.minecraft.item.ItemFood) {
				net.minecraft.item.ItemFood var3 = (net.minecraft.item.ItemFood) net.minecraft.item.Item.itemsList[var2.itemID];
