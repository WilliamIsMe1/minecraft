...
public class PlayerController {
	...
	public boolean sendBlockRemoved(int var1, int var2, int var3, int var4) {
		...
		net.minecraft.block.Block var6 = net.minecraft.block.Block.blocksList[var5.getBlockId(var1, var2, var3)];
	...
	public boolean sendUseItem(net.minecraft.entity.EntityPlayer var1, World var2, net.minecraft.item.ItemStack var3) {
		int var4 = var3.stackSize;
		net.minecraft.item.ItemStack var5 = var3.useItemRightClick(var2, var1);
	...
	public void func_6473_b(net.minecraft.entity.EntityPlayer var1) {
	}

	public boolean sendPlaceBlock(net.minecraft.entity.EntityPlayer var1, World var2, net.minecraft.item.ItemStack var3, int var4, int var5, int var6, int var7) {
	...
	public void interactWithEntity(net.minecraft.entity.EntityPlayer var1, net.minecraft.entity.Entity var2) {
		var1.useCurrentItemOnEntity(var2);
	}

	public void attackEntity(net.minecraft.entity.EntityPlayer var1, Entity var2) {
		var1.attackTargetEntityWithCurrentItem(var2);
	}

	public ItemStack func_27174_a(int var1, int var2, int var3, boolean var4, net.minecraft.entity.EntityPlayer var5) {
