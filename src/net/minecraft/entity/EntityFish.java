...
public class EntityFish extends net.minecraft.entity.Entity {
	private int xTile;
	private int yTile;
	private int zTile;
	private int inTile;
	...
	public int shake;
	public net.minecraft.entity.EntityPlayer angler;
	private int ticksInGround;
	private int ticksInAir;
	private int ticksCatchable;
	public net.minecraft.entity.Entity bobber;
	...
	public EntityFish(net.minecraft.world.World var1) {
		super(var1);
		this.xTile = -1;
		this.yTile = -1;
		this.zTile = -1;
	...
	public EntityFish(net.minecraft.world.World var1, double var2, double var4, double var6) {
		this(var1);
	...
	public void onUpdate() {
		...
		if(this.field_6388_l > 0) {
			...
			if(!this.worldObj.multiplayerWorld) {
				net.minecraft.item.ItemStack var1 = this.angler.getCurrentEquippedItem();
				if(this.angler.isDead || !this.angler.isEntityAlive() || var1 == null || var1.getItem() != net.minecraft.item.Item.fishingRod || this.getDistanceSqToEntity(this.angler) > 1024.0D) {
					this.setEntityDead();
