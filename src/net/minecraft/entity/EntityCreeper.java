...
public class EntityCreeper extends EntityMob {
	...
	protected void attackBlockedEntity(net.minecraft.entity.Entity var1, float var2) {
	...
	public void onDeath(net.minecraft.entity.Entity var1) {
		...
		if(var1 instanceof EntitySkeleton) {
			this.dropItem(net.minecraft.item.Item.record13.shiftedIndex + this.rand.nextInt(2), 1);
		}
