...
public class EntityFireball extends net.minecraft.entity.Entity {
	...
	public net.minecraft.entity.EntityLiving field_9397_j;
	...
	public EntityFireball(net.minecraft.world.World var1) {
		super(var1);
	...
	public EntityFireball(net.minecraft.world.World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
		super(var1);
		this.setSize(1.0F, 1.0F);
	...
	public void onUpdate() {
		...
		for(int var8 = 0; var8 < var5.size(); ++var8) {
			net.minecraft.entity.Entity var9 = (net.minecraft.entity.Entity)var5.get(var8);
		...
		if(var3 != null) {
			if(!this.worldObj.multiplayerWorld) {
				...
				this.worldObj.newExplosion((net.minecraft.entity.Entity)null, this.posX, this.posY, this.posZ, 1.0F, true);
			}
