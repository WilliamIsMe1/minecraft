...
import net.minecraft.client.render.ClippingHelperImpl;
import net.minecraft.client.render.ScaledResolution;
import net.minecraft.client.render.Frustrum;
...
public class EntityRenderer {
	...
	public net.minecraft.item.ItemRenderer itemRenderer;
	private int rendererUpdateCount;
	private net.minecraft.entity.Entity pointedEntity = null;
	private net.minecraft.client.MouseFilter mouseFilterXAxis = new net.minecraft.client.MouseFilter();
	private net.minecraft.client.MouseFilter mouseFilterYAxis = new net.minecraft.client.MouseFilter();
	private net.minecraft.client.MouseFilter mouseFilterDummy1 = new net.minecraft.client.MouseFilter();
	private net.minecraft.client.MouseFilter mouseFilterDummy2 = new net.minecraft.client.MouseFilter();
	private net.minecraft.client.MouseFilter mouseFilterDummy3 = new net.minecraft.client.MouseFilter();
	private net.minecraft.client.MouseFilter mouseFilterDummy4 = new MouseFilter();
	...
	public void getMouseOver(float var1) {
		if(this.mc.renderViewEntity != null) {
			if(this.mc.theWorld != null) {
				...
				double var4 = var2;
				net.minecraft.core.Vec3D var6 = this.mc.renderViewEntity.getPosition(var1);
				...
				net.minecraft.core.Vec3D var7 = this.mc.renderViewEntity.getLook(var1);
				net.minecraft.core.Vec3D var8 = var6.addVector(var7.xCoord * var2, var7.yCoord * var2, var7.zCoord * var2);
				...
				for(int var13 = 0; var13 < var10.size(); ++var13) {
					net.minecraft.entity.Entity var14 = (Entity)var10.get(var13);
					if(var14.canBeCollidedWith()) {
						...
						net.minecraft.misc.MovingObjectPosition var17 = var16.func_1169_a(var6, var8);
				...
				if(this.pointedEntity != null && !(this.mc.playerController instanceof PlayerControllerTest)) {
					this.mc.objectMouseOver = new net.minecraft.misc.MovingObjectPosition(this.pointedEntity);
				}
	...
	private float getFOVModifier(float var1) {
		net.minecraft.entity.EntityLiving var2 = this.mc.renderViewEntity;
		float var3 = 70.0F;
		if(var2.isInsideOfMaterial(net.minecraft.block.Material.water)) {
			var3 = 60.0F;
		}
	...
	private void setupViewBobbing(float var1) {
		if(this.mc.renderViewEntity instanceof net.minecraft.entity.EntityPlayer) {
			net.minecraft.entity.EntityPlayer var2 = (net.minecraft.entity.EntityPlayer)this.mc.renderViewEntity;
	...
	private void orientCamera(float var1) {
		...
		if(var2.isPlayerSleeping()) {
			...
			if(!this.mc.gameSettings.field_22273_E) {
				...
				if(var10 == net.minecraft.block.Block.blockBed.blockID) {
			...
			if(this.mc.gameSettings.field_22273_E) {
				...
				for(int var20 = 0; var20 < 8; ++var20) {
					...
					var22 *= 0.1F;
					var23 *= 0.1F;
					MovingObjectPosition var24 = this.mc.theWorld.rayTraceBlocks(net.minecraft.core.Vec3D.createVector(var4 + (double)var21, var6 + (double)var22, var8 + (double)var23), net.minecraft.core.Vec3D.createVector(var4 - var14 + (double)var21 + (double)var23, var6 - var18 + (double)var22, var8 - var16 + (double)var23));
					if(var24 != null) {
						double var25 = var24.hitVec.distanceTo(net.minecraft.core.Vec3D.createVector(var4, var6, var8));
						if(var25 < var27) {
							var27 = var25;
						}
					}
	...
	public void renderWorld(float var1, long var2) {
		...
		net.minecraft.client.render.RenderGlobal var5 = this.mc.renderGlobal;
		...
		int var16;
		if(var13 instanceof net.minecraft.world.ChunkProviderLoadOrGenerate) {
			net.minecraft.world.ChunkProviderLoadOrGenerate var14 = (ChunkProviderLoadOrGenerate)var13;
		...
		for(int var18 = 0; var18 < 2; ++var18) {
			...
			net.minecraft.entity.EntityPlayer var21;
			if(this.mc.objectMouseOver != null && var4.isInsideOfMaterial(net.minecraft.block.Material.water) && var4 instanceof net.minecraft.entity.EntityPlayer) {
				var21 = (net.minecraft.entity.EntityPlayer)var4;
			...
			if(this.cameraZoom == 1.0D && var4 instanceof net.minecraft.entity.EntityPlayer && this.mc.objectMouseOver != null && !var4.isInsideOfMaterial(net.minecraft.block.Material.water)) {
		...
		if(var1 != 0.0F) {
			...
			for(int var15 = 0; var15 < (int)(100.0F * var1 * var1); ++var15) {
				...
				if(var18 <= var5 + var7 && var18 >= var5 - var7 && var3.getWorldChunkManager().getBiomeGenAt(var16, var17).canSpawnLightningBolt()) {
					...
					if(var19 > 0) {
						if(net.minecraft.block.Block.blocksList[var19].blockMaterial == net.minecraft.block.Material.lava) {
							this.mc.effectRenderer.addEffect(new EntitySmokeFX(var3, (double)((float)var16 + var20), (double)((float)var18 + 0.1F) - net.minecraft.block.Block.blocksList[var19].minY, (double)((float)var17 + var21), 0.0D, 0.0D, 0.0D));
						} else {
							++var14;
							if(this.random.nextInt(var14) == 0) {
								var8 = (double)((float)var16 + var20);
								var10 = (double)((float)var18 + 0.1F) - net.minecraft.block.Block.blocksList[var19].minY;
	...
	protected void renderRainSnow(float var1) {
		...
		if(var2 > 0.0F) {
			net.minecraft.entity.EntityLiving var3 = this.mc.renderViewEntity;
			...
			net.minecraft.world.BiomeGenBase[] var17 = var4.getWorldChunkManager().func_4069_a(var5 - var16, var7 - var16, var16 * 2 + 1, var16 * 2 + 1);
			int var18 = 0;

			int var19;
			int var20;
			net.minecraft.world.BiomeGenBase var21;
			int var22;
			int var23;
			int var24;
			float var26;
	...
	private void updateFogColor(float var1) {
		...
		net.minecraft.core.Vec3D var5 = var2.func_4079_a(this.mc.renderViewEntity, var1);
		float var6 = (float)var5.xCoord;
		float var7 = (float)var5.yCoord;
		float var8 = (float)var5.zCoord;
		net.minecraft.core.Vec3D var9 = var2.getFogColor(var1);
		...
		} else if(var3.isInsideOfMaterial(net.minecraft.block.Material.water)) {
			this.fogColorRed = 0.02F;
			this.fogColorGreen = 0.02F;
			this.fogColorBlue = 0.2F;
		} else if(var3.isInsideOfMaterial(net.minecraft.block.Material.lava)) {
