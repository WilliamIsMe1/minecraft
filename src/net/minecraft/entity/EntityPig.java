...
public class EntityPig extends EntityAnimal {
	...
	protected int getDropItemId() {
		return this.fire > 0 ? net.minecraft.item.Item.porkCooked.shiftedIndex : Item.porkRaw.shiftedIndex;
	}
	...
	protected void fall(float var1) {
		super.fall(var1);
		if(var1 > 5.0F && this.riddenByEntity instanceof net.minecraft.entity.EntityPlayer) {
