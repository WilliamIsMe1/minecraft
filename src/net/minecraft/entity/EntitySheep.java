...
public class EntitySheep extends EntityAnimal {
	...
	protected void dropFewItems() {
		if(!this.getSheared()) {
			this.entityDropItem(new net.minecraft.item.ItemStack(net.minecraft.block.Block.cloth.blockID, 1, this.getFleeceColor()), 0.0F);
		}

	}

	protected int getDropItemId() {
		return net.minecraft.block.Block.cloth.blockID;
	}
