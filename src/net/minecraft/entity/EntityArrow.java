...
public class EntityArrow extends net.minecraft.entity.Entity {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public net.minecraft.entity.EntityLiving owner;
	private int ticksInGround;
	private int ticksInAir = 0;

	public EntityArrow(net.minecraft.world.World var1) {
		super(var1);
		this.setSize(0.5F, 0.5F);
	}

	public EntityArrow(net.minecraft.world.World var1, double var2, double var4, double var6) {
		super(var1);
		this.setSize(0.5F, 0.5F);
