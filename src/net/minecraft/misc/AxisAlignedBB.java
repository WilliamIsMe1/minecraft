...
public class AxisAlignedBB {
	...
	public boolean isVecInside(net.minecraft.core.Vec3D var1) {
	...
	public MovingObjectPosition func_1169_a(net.minecraft.core.Vec3D var1, net.minecraft.core.Vec3D var2) {
		net.minecraft.core.Vec3D var3 = var1.getIntermediateWithXValue(var2, this.minX);
		net.minecraft.core.Vec3D var4 = var1.getIntermediateWithXValue(var2, this.maxX);
		net.minecraft.core.Vec3D var5 = var1.getIntermediateWithYValue(var2, this.minY);
		net.minecraft.core.Vec3D var6 = var1.getIntermediateWithYValue(var2, this.maxY);
		net.minecraft.core.Vec3D var7 = var1.getIntermediateWithZValue(var2, this.minZ);
		net.minecraft.core.Vec3D var8 = var1.getIntermediateWithZValue(var2, this.maxZ);
		...
		net.minecraft.core.Vec3D var9 = null;
	...
	private boolean isVecInYZ(net.minecraft.core.Vec3D var1) {
		return var1 == null ? false : var1.yCoord >= this.minY && var1.yCoord <= this.maxY && var1.zCoord >= this.minZ && var1.zCoord <= this.maxZ;
	}

	private boolean isVecInXZ(net.minecraft.core.Vec3D var1) {
