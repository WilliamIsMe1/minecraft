...
public class SoundManager {
	...
	private net.minecraft.sound.SoundPool soundPoolSounds = new net.minecraft.sound.SoundPool();
	private net.minecraft.sound.SoundPool soundPoolStreaming = new net.minecraft.sound.SoundPool();
	private net.minecraft.sound.SoundPool soundPoolMusic = new SoundPool();
	...
	public void playRandomMusicIfReady() {
		if(loaded && this.options.musicVolume != 0.0F) {
			if(!sndSystem.playing("BgMusic") && !sndSystem.playing("streaming")) {
				...
				net.minecraft.sound.SoundPoolEntry var1 = this.soundPoolMusic.getRandomSound();
				if(var1 != null) {
	...
	public void func_338_a(EntityLiving var1, float var2) {
		if(loaded && this.options.soundVolume != 0.0F) {
			if(var1 != null) {
				...
				float var10 = net.minecraft.core.MathHelper.cos(-var3 * ((float)Math.PI / 180.0F) - (float)Math.PI);
	...
	public void playStreaming(String var1, float var2, float var3, float var4, float var5, float var6) {
		if(loaded && this.options.soundVolume != 0.0F) {
			...
			if(var1 != null) {
				net.minecraft.sound.SoundPoolEntry var8 = this.soundPoolStreaming.getRandomSoundFromSoundPool(var1);
	...
	public void playSound(String var1, float var2, float var3, float var4, float var5, float var6) {
		if(loaded && this.options.soundVolume != 0.0F) {
			net.minecraft.sound.SoundPoolEntry var7 = this.soundPoolSounds.getRandomSoundFromSoundPool(var1);
