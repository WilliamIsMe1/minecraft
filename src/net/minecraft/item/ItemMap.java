					...
					for(int var17 = var10 - var11 - 1; var17 < var10 + var11; ++var17) {
						if(var12 >= 0 && var17 >= -1 && var12 < var4 && var17 < var5) {
							...
							if(var1.worldProvider.hasNoSky) {
								...
								if((var33 >> 20 & 1) == 0) {
									var26[net.minecraft.block.Block.dirt.blockID] += 10;
								} else {
									var26[net.minecraft.block.Block.stone.blockID] += 10;
								}
									...
									for(var34 = 0; var34 < var6; ++var34) {
										...
										if(var35 > 1) {
											...
											while(true) {
												...
												if(var37) {
													if(var36 == 0 || !net.minecraft.block.Block.blocksList[var36].blockMaterial.getIsLiquid()) {
														break;
													}
													...
													while(true) {
														...
														++var30;
														if(var38 <= 0 || var43 == 0 || !net.minecraft.block.Block.blocksList[var43].blockMaterial.getIsLiquid()) {
															break label164;
														}
													}
												}
