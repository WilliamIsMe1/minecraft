...
public class ShapedRecipes implements IRecipe {
	...
	public ShapedRecipes(int var1, int var2, net.minecraft.item.ItemStack[] var3, net.minecraft.item.ItemStack var4) {
	...
	private boolean func_21137_a(net.minecraft.item.InventoryCrafting var1, int var2, int var3, boolean var4) {
		for(int var5 = 0; var5 < 3; ++var5) {
			for(int var6 = 0; var6 < 3; ++var6) {
				int var7 = var5 - var2;
				int var8 = var6 - var3;
				net.minecraft.item.ItemStack var9 = null;
				...
				net.minecraft.item.ItemStack var10 = var1.func_21103_b(var5, var6);
	...
	public net.minecraft.item.ItemStack getCraftingResult(InventoryCrafting var1) {
