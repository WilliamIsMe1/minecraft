...
public class CraftingManager {
	...
	public void addRecipe(ItemStack var1, Object... var2) {
		...
		HashMap<Character, ItemStack> characterToItemMap;
		for(characterToItemMap = new HashMap<>(); var4 < var2.length; var4 += 2) {
			...
			characterToItemMap.put(var13, var15);
		}
		...
		for(int var16 = 0; var16 < var5 * var6; ++var16) {
			...
			if(characterToItemMap.containsKey(var10)) {
				var14[var16] = characterToItemMap.get(var10).copy();
			} else {
				var14[var16] = null;
			}
		}
