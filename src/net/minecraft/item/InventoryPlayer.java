...
public class InventoryPlayer implements IInventory {
	...
	public net.minecraft.entity.EntityPlayer player;
	private ItemStack itemStack;
	public boolean inventoryChanged = false;

	public InventoryPlayer(net.minecraft.entity.EntityPlayer var1) {
		this.player = var1;
	}
	...
	public net.minecraft.util.nbt.NBTTagList writeToNBT(net.minecraft.util.nbt.NBTTagList var1) {
		int var2;
		net.minecraft.util.nbt.NBTTagCompound var3;
		for(var2 = 0; var2 < this.mainInventory.length; ++var2) {
			if(this.mainInventory[var2] != null) {
				var3 = new net.minecraft.util.nbt.NBTTagCompound();
	...
	public void readFromNBT(NBTTagList var1) {
		...
		for(int var2 = 0; var2 < var1.tagCount(); ++var2) {
			net.minecraft.util.nbt.NBTTagCompound var3 = (net.minecraft.util.nbt.NBTTagCompound)var1.tagAt(var2);
