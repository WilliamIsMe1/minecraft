...
public final class ItemStack {
	...
	public ItemStack(net.minecraft.block.Block var1) {
		this((net.minecraft.block.Block)var1, 1);
	}

	public ItemStack(net.minecraft.block.Block var1, int var2) {
		this(var1.blockID, var2, 0);
	}

	public ItemStack(net.minecraft.block.Block var1, int var2, int var3) {
	...
	public float getStrVsBlock(net.minecraft.block.Block var1) {
		return this.getItem().getStrVsBlock(this, var1);
	}

	public ItemStack useItemRightClick(net.minecraft.world.World var1, net.minecraft.entity.EntityPlayer var2) {
		return this.getItem().onItemRightClick(this, var1, var2);
	}

	public net.minecraft.util.nbt.NBTTagCompound writeToNBT(net.minecraft.util.nbt.NBTTagCompound var1) {
	...
	public void func_1097_a(net.minecraft.entity.EntityPlayer var1) {
	}

	public void useItemOnEntity(net.minecraft.entity.EntityLiving var1) {
	...
	public void updateAnimation(net.minecraft.world.World var1, net.minecraft.entity.Entity var2, int var3, boolean var4) {
