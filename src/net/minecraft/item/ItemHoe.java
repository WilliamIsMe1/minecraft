...
public class ItemHoe extends Item {
	...
	public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7) {
		...
		if((var7 == 0 || var9 != 0 || var8 != net.minecraft.block.Block.grass.blockID) && var8 != net.minecraft.block.Block.dirt.blockID) {
			return false;
		} else {
			net.minecraft.block.Block var10 = Block.tilledField;
