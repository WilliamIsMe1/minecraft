...
public class ItemBlock extends Item {
	...
	public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7) {
		...
		if(var1.stackSize == 0) {
			return false;
		} else if(var5 == 127 && Block.blocksList[this.blockID].getBlockMaterial().isSolid()) {
			return false;
			...
			if(var3.setBlockAndMetadataWithNotify(var4, var5, var6, this.blockID, this.getPlacedBlockMetadata(var1.getItemDamage()))) {
				...
				var3.playSoundEffect((double)((float)var4 + 0.5F), (double)((float)var5 + 0.5F), (double)((float)var6 + 0.5F), var8.getStepSound().func_1145_d(), (var8.getStepSound().getVolume() + 1.0F) / 2.0F, var8.getStepSound().getPitch() * 0.8F);
				--var1.stackSize;
			}
