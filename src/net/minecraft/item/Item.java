...
public class Item {
	...
	public static Item doorWood = (new ItemDoor(68, net.minecraft.block.Material.wood)).setIconCoord(11, 2).setItemName("doorWood");
	public static Item bucketEmpty = (new ItemBucket(69, 0)).setIconCoord(10, 4).setItemName("bucket");
	public static Item bucketWater = (new ItemBucket(70, net.minecraft.block.Block.waterMoving.blockID)).setIconCoord(11, 4).setItemName("bucketWater").setContainerItem(bucketEmpty);
	public static Item bucketLava = (new ItemBucket(71, net.minecraft.block.Block.lavaMoving.blockID)).setIconCoord(12, 4).setItemName("bucketLava").setContainerItem(bucketEmpty);
	...
	public static Item reed = (new ItemReed(82, net.minecraft.block.Block.reed)).setIconCoord(11, 1).setItemName("reeds");
	...
	public static Item cake = (new ItemReed(98, net.minecraft.block.Block.cake)).setMaxStackSize(1).setIconCoord(13, 1).setItemName("cake");
	public static Item bed = (new ItemBed(99)).setMaxStackSize(1).setIconCoord(13, 2).setItemName("bed");
	public static Item redstoneRepeater = (new ItemReed(100, net.minecraft.block.Block.redstoneRepeaterIdle)).setIconCoord(6, 5).setItemName("diode");
	...
	public boolean onItemUse(ItemStack var1, net.minecraft.entity.EntityPlayer var2, net.minecraft.world.World var3, int var4, int var5, int var6, int var7) {
		return false;
	}
	...
	public ItemStack onItemRightClick(ItemStack var1, net.minecraft.world.World var2, net.minecraft.entity.EntityPlayer var3) {
		return var1;
	}
	...
	public boolean hitEntity(ItemStack var1, net.minecraft.entity.EntityLiving var2, net.minecraft.entity.EntityLiving var3) {
		return false;
	}

	public boolean onBlockDestroyed(ItemStack var1, int var2, int var3, int var4, int var5, net.minecraft.entity.EntityLiving var6) {
		return false;
	}
	...
	public void saddleEntity(ItemStack var1, net.minecraft.entity.EntityLiving var2) {
	}
