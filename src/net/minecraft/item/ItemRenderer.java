...
public class ItemRenderer {
	...
	private net.minecraft.client.render.RenderBlocks renderBlocksInstance = new net.minecraft.client.render.RenderBlocks();
	private net.minecraft.client.render.MapItemRenderer field_28131_f;
	...
	public void renderItem(EntityLiving var1, ItemStack var2) {
		GL11.glPushMatrix();
		if(var2.itemID < 256 && net.minecraft.client.render.RenderBlocks.renderItemIn3d(net.minecraft.block.Block.blocksList[var2.itemID].getRenderType())) {
			GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/terrain.png"));
			this.renderBlocksInstance.renderBlockOnInventory(net.minecraft.block.Block.blocksList[var2.itemID], var2.getItemDamage(), var1.getEntityBrightness(1.0F));
		} else {
			if(var2.itemID < 256) {
				GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/terrain.png"));
			} else {
			...
			net.minecraft.client.render.Tessellator var3 = net.minecraft.client.render.Tessellator.instance;
	...
	public void renderItemInFirstPerson(float var1) {
		...
		net.minecraft.entity.EntityPlayerSP var3 = this.mc.thePlayer;
		...
		if(var5 != null && var5.itemID == Item.mapItem.shiftedIndex) {
			...
			for(int var17 = 0; var17 < 2; ++var17) {
				...
				net.minecraft.client.render.Render var11 = net.minecraft.client.render.RenderManager.instance.getEntityRenderObject(this.mc.thePlayer);
				net.minecraft.client.render.RenderPlayer var12 = (net.minecraft.client.render.RenderPlayer)var11;
				float var13 = 1.0F;
			...
			net.minecraft.client.render.Tessellator var19 = net.minecraft.client.render.Tessellator.instance;
			...
			Render var15 = net.minecraft.client.render.RenderManager.instance.getEntityRenderObject(this.mc.thePlayer);
			net.minecraft.client.render.RenderPlayer var16 = (RenderPlayer)var15;
			var10 = 1.0F;
			GL11.glScalef(var10, var10, var10);
	...
	public void renderOverlays(float var1) {
		...
		if(this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
			...
			if(this.mc.theWorld.isBlockNormalCube(var2, var3, var4)) {
				this.renderInsideOfBlock(var1, net.minecraft.block.Block.blocksList[var6].getBlockTextureFromSide(2));
			} else {
			...
			if(net.minecraft.block.Block.blocksList[var6] != null) {
				this.renderInsideOfBlock(var1, net.minecraft.block.Block.blocksList[var6].getBlockTextureFromSide(2));
			}
		}
	...
	private void renderWarpedTextureOverlay(float var1) {
		net.minecraft.client.render.Tessellator var2 = net.minecraft.client.render.Tessellator.instance;
	...
	private void renderFireInFirstPerson(float var1) {
		net.minecraft.client.render.Tessellator var2 = Tessellator.instance;
