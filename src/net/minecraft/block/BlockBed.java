...
public class BlockBed extends Block {
	...
	public boolean blockActivated(net.minecraft.world.World var1, int var2, int var3, int var4, EntityPlayer var5) {
		if(var1.multiplayerWorld) {
			...
			if(!var1.worldProvider.canRespawnHere()) {
				...
				var1.newExplosion((net.minecraft.entity.Entity)null, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F), 5.0F, true);
				return true;
			} else {
	...
	public static void setBedOccupied(net.minecraft.world.World var0, int var1, int var2, int var3, boolean var4) {
