...
public class Block {
	...
	public static final Block pressurePlateStone = (new BlockPressurePlate(70, stone.blockIndexInTexture, net.minecraft.entity.EnumMobType.mobs, Material.rock)).setHardness(0.5F).setStepSound(soundStoneFootstep).setBlockName("pressurePlate").disableNeighborNotifyOnMetadataChange();
	...
	public boolean getIsBlockSolid(net.minecraft.block.IBlockAccess var1, int var2, int var3, int var4, int var5) {
		return var1.getBlockMaterial(var2, var3, var4).isSolid();
	}

	public int getBlockTexture(net.minecraft.block.IBlockAccess var1, int var2, int var3, int var4, int var5) {
	...
	public net.minecraft.misc.AxisAlignedBB getSelectedBoundingBoxFromPool(net.minecraft.world.World var1, int var2, int var3, int var4) {
		return net.minecraft.misc.AxisAlignedBB.getBoundingBoxFromPool((double)var2 + this.minX, (double)var3 + this.minY, (double)var4 + this.minZ, (double)var2 + this.maxX, (double)var3 + this.maxY, (double)var4 + this.maxZ);
	}
	...
	public float blockStrength(net.minecraft.entity.EntityPlayer var1) {
		...
		if(!var1.multiplayerWorld) {
			...
			for(int var8 = 0; var8 < var7; ++var8) {
				if(var1.rand.nextFloat() <= var6) {
					...
					if(var9 > 0) {
						this.dropBlockAsItem_do(var1, var2, var3, var4, new net.minecraft.item.ItemStack(var9, 1, this.damageDropped(var5)));
					}
				}
			}
	...
	public int colorMultiplier(net.minecraft.block.IBlockAccess var1, int var2, int var3, int var4) {
		return 16777215;
	}
	...
	static {
		net.minecraft.item.Item.itemsList[cloth.blockID] = (new net.minecraft.item.ItemCloth(cloth.blockID - 256)).setItemName("cloth");
		net.minecraft.item.Item.itemsList[wood.blockID] = (new net.minecraft.item.ItemLog(wood.blockID - 256)).setItemName("log");
		net.minecraft.item.Item.itemsList[stairSingle.blockID] = (new net.minecraft.item.ItemSlab(stairSingle.blockID - 256)).setItemName("stoneSlab");
		net.minecraft.item.Item.itemsList[sapling.blockID] = (new net.minecraft.item.ItemSapling(sapling.blockID - 256)).setItemName("sapling");
		net.minecraft.item.Item.itemsList[leaves.blockID] = (new net.minecraft.item.ItemLeaves(leaves.blockID - 256)).setItemName("leaves");
		net.minecraft.item.Item.itemsList[pistonBase.blockID] = new net.minecraft.item.ItemPiston(pistonBase.blockID - 256);
		net.minecraft.item.Item.itemsList[pistonStickyBase.blockID] = new net.minecraft.item.ItemPiston(pistonStickyBase.blockID - 256);

		for(int var0 = 0; var0 < 256; ++var0) {
			if(blocksList[var0] != null && net.minecraft.item.Item.itemsList[var0] == null) {
				net.minecraft.item.Item.itemsList[var0] = new net.minecraft.item.ItemBlock(var0 - 256);
