...
public class BlockPistonBase extends Block {
	...
	public int getBlockTextureFromSideAndMetadata(int var1, int var2) {
		...
		return var3 > 5 ? this.blockIndexInTexture : (var1 == var3 ? (!isPowered(var2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? this.blockIndexInTexture : 110) : (var1 == net.minecraft.client.render.PistonBlockTextures.field_31057_a[var3] ? 109 : 108));
	}
	...
	public void onBlockPlacedBy(net.minecraft.world.World var1, int var2, int var3, int var4, net.minecraft.entity.EntityLiving var5) {
		int var6 = func_31039_c(var1, var2, var3, var4, (net.minecraft.entity.EntityPlayer)var5);
