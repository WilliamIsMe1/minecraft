...
public class BlockDispenser extends BlockContainer {
	...
	private void dispenseItem(net.minecraft.world.World var1, int var2, int var3, int var4, Random var5) {
		int var6 = var1.getBlockMetadata(var2, var3, var4);
		byte var9 = 0;
		byte var10 = 0;
		if(var6 == 3) {
		...
		net.minecraft.item.ItemStack var12 = var11.getRandomStackFromInventory();
		...
		if(var12 == null) {
			...
			if(var12.itemID == net.minecraft.item.Item.arrow.shiftedIndex) {
				net.minecraft.entity.EntityArrow var19 = new net.minecraft.entity.EntityArrow(var1, var13, var15, var17);
			...
			} else if(var12.itemID == net.minecraft.item.Item.egg.shiftedIndex) {
				net.minecraft.entity.EntityEgg var22 = new net.minecraft.entity.EntityEgg(var1, var13, var15, var17);
				var22.setEggHeading((double)var9, (double)0.1F, (double)var10, 1.1F, 6.0F);
				var1.entityJoinedWorld(var22);
				var1.func_28106_e(1002, var2, var3, var4, 0);
			} else if(var12.itemID == net.minecraft.item.Item.snowball.shiftedIndex) {
				net.minecraft.entity.EntitySnowball var23 = new EntitySnowball(var1, var13, var15, var17);
				var23.setSnowballHeading((double)var9, (double)0.1F, (double)var10, 1.1F, 6.0F);
				var1.entityJoinedWorld(var23);
				var1.func_28106_e(1002, var2, var3, var4, 0);
			} else {
				net.minecraft.entity.EntityItem var24 = new net.minecraft.entity.EntityItem(var1, var13, var15 - 0.3D, var17, var12);
		...
		for(int var6 = 0; var6 < var5.getSizeInventory(); ++var6) {
			...
			if(var7 != null) {
				...
				while(var7.stackSize > 0) {
					...
					net.minecraft.entity.EntityItem var12 = new net.minecraft.entity.EntityItem(var1, (double)((float)var2 + var8), (double)((float)var3 + var9), (double)((float)var4 + var10), new ItemStack(var7.itemID, var11, var7.getItemDamage()));
					float var13 = 0.05F;
