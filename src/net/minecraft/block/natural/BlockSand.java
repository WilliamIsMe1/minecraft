...
public class BlockSand extends Block {
	...
	private void tryToFall(World var1, int var2, int var3, int var4) {
		if(canFallBelow(var1, var2, var3 - 1, var4) && var3 >= 0) {
			...
			if(!fallInstantly && var1.checkChunksExist(var2 - var8, var3 - var8, var4 - var8, var2 + var8, var3 + var8, var4 + var8)) {
				EntityFallingSand var9 = new EntityFallingSand(var1, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F), this.getBlockID());
				...
				if(var3 > 0) {
					var1.setBlockWithNotify(var2, var3, var4, this.getBlockID());
				}
			}
		}
	...
	public static boolean canFallBelow(World var0, int var1, int var2, int var3) {
		...
		if(var4 == 0) {
			return true;
		} else if(var4 == Block.fire.getBlockID()) {
			return true;
		} else {
			Material var5 = Block.blocksList[var4].getBlockMaterial();
