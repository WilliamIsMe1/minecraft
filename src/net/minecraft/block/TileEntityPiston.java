...
public class TileEntityPiston extends TileEntity {
	...
	private void func_31010_a(float var1, float var2) {
		...
		AxisAlignedBB var3 = net.minecraft.block.Block.pistonMoving.func_31035_a(this.worldObj, this.xCoord, this.yCoord, this.zCoord, this.storedBlockID, var1, this.field_31025_c);
		if(var3 != null) {
	...
	public void func_31011_l() {
		if(this.field_31020_l < 1.0F) {
			...
			this.func_31005_i();
			if(this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord) == net.minecraft.block.Block.pistonMoving.blockID) {
