...
public class TileEntityChest extends TileEntity implements IInventory {
	private net.minecraft.item.ItemStack[] chestContents = new net.minecraft.item.ItemStack[36];
	...
	public void readFromNBT(net.minecraft.util.nbt.NBTTagCompound var1) {
		...
		this.chestContents = new net.minecraft.item.ItemStack[this.getSizeInventory()];
