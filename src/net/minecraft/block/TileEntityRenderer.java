...
public class TileEntityRenderer {
	...
	public net.minecraft.client.render.RenderEngine renderEngine;
	public net.minecraft.world.World worldObj;
	public net.minecraft.entity.EntityLiving entityLivingPlayer;
	...
	private TileEntityRenderer() {
		...
		while(var1.hasNext()) {
			net.minecraft.client.render.TileEntitySpecialRenderer var2 = (net.minecraft.client.render.TileEntitySpecialRenderer)var1.next();
			var2.setTileEntityRenderer(this);
		}

	}

	public net.minecraft.client.render.TileEntitySpecialRenderer getSpecialRendererForClass(Class var1) {
		net.minecraft.client.render.TileEntitySpecialRenderer var2 = (net.minecraft.client.render.TileEntitySpecialRenderer)this.specialRendererMap.get(var1);
	...
	public net.minecraft.client.render.TileEntitySpecialRenderer getSpecialRendererForEntity(TileEntity var1) {
		return var1 == null ? null : this.getSpecialRendererForClass(var1.getClass());
	}

	public void cacheActiveRenderInfo(net.minecraft.world.World var1, RenderEngine var2, FontRenderer var3, EntityLiving var4, float var5) {
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		net.minecraft.client.render.TileEntitySpecialRenderer var9 = this.getSpecialRendererForEntity(var1);
		if(var9 != null) {
	...
	public void func_31072_a(World var1) {
		...
		while(var2.hasNext()) {
			net.minecraft.client.render.TileEntitySpecialRenderer var3 = (TileEntitySpecialRenderer)var2.next();
			if(var3 != null) {
