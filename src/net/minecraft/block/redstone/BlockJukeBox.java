...
import net.minecraft.block.tileentity.TileEntityRecordPlayer;
...
public class BlockJukeBox extends BlockContainer {
	...
	public void func_28038_b_(net.minecraft.world.World var1, int var2, int var3, int var4) {
		if(!var1.multiplayerWorld) {
			...
			if(var6 != 0) {
				...
				net.minecraft.entity.EntityItem var15 = new EntityItem(var1, (double)var2 + var9, (double)var3 + var11, (double)var4 + var13, new ItemStack(var6, 1, 0));
