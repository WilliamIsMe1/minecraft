...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer {
	private net.minecraft.client.render.RenderBlocks field_31071_b;

	public void func_31070_a(TileEntityPiston var1, double var2, double var4, double var6, float var8) {
		net.minecraft.block.Block var9 = net.minecraft.block.Block.blocksList[var1.getStoredBlockID()];
		if(var9 != null && var1.func_31008_a(var8) < 1.0F) {
			net.minecraft.client.render.Tessellator var10 = Tessellator.instance;
			...
			if(var9 == net.minecraft.block.Block.pistonExtension && var1.func_31008_a(var8) < 0.5F) {
				...
				net.minecraft.block.Block.pistonExtension.func_31052_a_(((BlockPistonBase)var9).func_31040_i());
				this.field_31071_b.func_31079_a(net.minecraft.block.Block.pistonExtension, var1.xCoord, var1.yCoord, var1.zCoord, var1.func_31008_a(var8) < 0.5F);
	...
	public void func_31069_a(World var1) {
		this.field_31071_b = new net.minecraft.client.render.RenderBlocks(var1);
	}
