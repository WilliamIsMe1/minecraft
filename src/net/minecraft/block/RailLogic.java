...
public class RailLogic {
	...
	final net.minecraft.block.BlockRail rail;

	public RailLogic(net.minecraft.block.BlockRail var1, World var2, int var3, int var4, int var5) {
		this.rail = var1;
		...
		if(net.minecraft.block.BlockRail.isPoweredBlockRail((net.minecraft.block.BlockRail) Block.blocksList[var6])) {
	...
	private boolean isMinecartTrack(int var1, int var2, int var3) {
		return net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, var1, var2, var3) ? true : (net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, var1, var2 + 1, var3) ? true : net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, var1, var2 - 1, var3));
	}

	private RailLogic getMinecartTrackLogic(ChunkPosition var1) {
		return net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, var1.x, var1.y, var1.z) ? new RailLogic(this.rail, this.worldObj, var1.x, var1.y, var1.z) : (net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, var1.x, var1.y + 1, var1.z) ? new RailLogic(this.rail, this.worldObj, var1.x, var1.y + 1, var1.z) : (net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, var1.x, var1.y - 1, var1.z) ? new RailLogic(this.rail, this.worldObj, var1.x, var1.y - 1, var1.z) : null));
	}
	...
	private void func_788_d(RailLogic var1) {
		...
		if(var6 == 0) {
			if(net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, this.trackX, this.trackY + 1, this.trackZ - 1)) {
				var6 = 4;
			}
		...
		if(var6 == 1) {
			if(net.minecraft.block.BlockRail.isRailBlockAt(this.worldObj, this.trackX + 1, this.trackY + 1, this.trackZ)) {
				var6 = 2;
			}
