...
public class TileEntityDispenser extends TileEntity implements IInventory {
	private net.minecraft.item.ItemStack[] dispenserContents = new net.minecraft.item.ItemStack[9];
	...
	public net.minecraft.item.ItemStack getRandomStackFromInventory() {
		int var1 = -1;
		int var2 = 1;
	...
	public void readFromNBT(net.minecraft.util.nbt.NBTTagCompound var1) {
		...
		this.dispenserContents = new net.minecraft.item.ItemStack[this.getSizeInventory()];
