...
public class Block {
	...
	public static final Block pressurePlateStone             = (new BlockPressurePlate(70, stone.getBlockIndexInTexture(), net.minecraft.entity.EnumMobType.mobs, Material.rock)).setHardness(0.5F).setStepSound(soundStoneFootstep).setBlockName("pressurePlate").disableNeighborNotifyOnMetadataChange();
	...
	public static final Block pressurePlatePlanks            = (new BlockPressurePlate(72, planks.getBlockIndexInTexture(), EnumMobType.everything, Material.wood)).setHardness(0.5F).setStepSound(soundWoodFootstep).setBlockName("pressurePlate").disableNeighborNotifyOnMetadataChange();
	...
	public static final Block button                         = (new BlockButton(77, stone.getBlockIndexInTexture())).setHardness(0.5F).setStepSound(soundStoneFootstep).setBlockName("button").disableNeighborNotifyOnMetadataChange();
	...
	private boolean blockConstructorCalled;
	...
	protected Block(int var1, Material var2) {
		this.setBlockConstructorCalled(true);
		this.setEnableStats(true);
		this.setStepSound_(soundPowderFootstep);
		this.setBlockParticleGravity(1.0F);
		this.setSlipperiness(0.6F);
	...
	protected Block disableNeighborNotifyOnMetadataChange() {
		field_28032_t[this.getBlockID()] = true;
		return this;
	}
	...
	protected Block setStepSound(StepSound var1) {
		this.setStepSound_(var1);
		return this;
	}

	protected Block setLightOpacity(int var1) {
		lightOpacity[this.getBlockID()] = var1;
		return this;
	}

	protected Block setLightValue(float var1) {
		lightValue[this.getBlockID()] = (int)(15.0F * var1);
		return this;
	}

	protected Block setResistance(float var1) {
		this.setBlockResistance(var1 * 3.0F);
		return this;
	}
	...
	protected Block setHardness(float var1) {
		this.setBlockHardness(var1);
		if(this.getBlockResistance() < var1 * 5.0F) {
			this.setBlockResistance(var1 * 5.0F);
		}
	...
	public float getHardness() {
		return this.getBlockHardness();
	}

	protected Block setTickOnLoad(boolean var1) {
		tickOnLoad[this.getBlockID()] = var1;
		return this;
	}

	public void setBlockBounds(float var1, float var2, float var3, float var4, float var5, float var6) {
		this.setMinX((double)var1);
		this.setMinY((double)var2);
		this.setMinZ((double)var3);
		this.setMaxX((double)var4);
		this.setMaxY((double)var5);
		this.setMaxZ((double)var6);
	}

	public float getBlockBrightness(IBlockAccess var1, int var2, int var3, int var4) {
		return var1.getBrightness(var2, var3, var4, lightValue[this.getBlockID()]);
	}

	public boolean shouldSideBeRendered(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		if (var5 == 0 && this.getMinY() > 0.0D) {
			return true;
		}

		if (var5 == 1 && this.getMaxY() < 1.0D) {
			return true;
		}

		if (var5 == 2 && this.getMinZ() > 0.0D) {
			return true;
		}

		if (var5 == 3 && this.getMaxZ() < 1.0D) {
			return true;
		}

		if (var5 == 4 && this.getMinX() > 0.0D) {
			return true;
		}

		if (var5 == 5 && this.getMaxX() < 1.0D) {
			return true;
		}
	...
	public net.minecraft.misc.AxisAlignedBB getSelectedBoundingBoxFromPool(net.minecraft.world.World var1, int var2, int var3, int var4) {
		return net.minecraft.misc.AxisAlignedBB.getBoundingBoxFromPool((double)var2 + this.getMinX(), (double)var3 + this.getMinY(), (double)var4 + this.getMinZ(), (double)var2 + this.getMaxX(), (double)var3 + this.getMaxY(), (double)var4 + this.getMaxZ());
	}

	public void getCollidingBoundingBoxes(net.minecraft.world.World var1, int var2, int var3, int var4, net.minecraft.misc.AxisAlignedBB var5, ArrayList<AxisAlignedBB> var6) {
		net.minecraft.misc.AxisAlignedBB var7 = this.getCollisionBoundingBoxFromPool(var1, var2, var3, var4);
	...
	public net.minecraft.misc.AxisAlignedBB getCollisionBoundingBoxFromPool(net.minecraft.world.World var1, int var2, int var3, int var4) {
		return AxisAlignedBB.getBoundingBoxFromPool((double)var2 + this.getMinX(), (double)var3 + this.getMinY(), (double)var4 + this.getMinZ(), (double)var2 + this.getMaxX(), (double)var3 + this.getMaxY(), (double)var4 + this.getMaxZ());
	}
	...
	public float blockStrength(EntityPlayer var1) {
		return this.getBlockHardness() < 0.0F ? 0.0F : (!var1.canHarvestBlock(this) ? 1.0F / this.getBlockHardness() / 100.0F : var1.getCurrentPlayerStrVsBlock(this) / this.getBlockHardness() / 30.0F);
	}
	...
	public float getExplosionResistance(net.minecraft.entity.Entity var1) {
		return this.getBlockResistance() / 5.0F;
	}

	public net.minecraft.misc.MovingObjectPosition collisionRayTrace(net.minecraft.world.World world, int var2, int var3, int var4, net.minecraft.core.Vec3D var5, net.minecraft.core.Vec3D var6) {
		this.setBlockBoundsBasedOnState(world, var2, var3, var4);
		var5 = var5.addVector(-var2, -var3, -var4);
		var6 = var6.addVector(-var2, -var3, -var4);
		net.minecraft.core.Vec3D var7 = var5.getIntermediateWithXValue(var6, this.getMinX());
		net.minecraft.core.Vec3D var8 = var5.getIntermediateWithXValue(var6, this.getMaxX());
		net.minecraft.core.Vec3D var9 = var5.getIntermediateWithYValue(var6, this.getMinY());
		net.minecraft.core.Vec3D var10 = var5.getIntermediateWithYValue(var6, this.getMaxY());
		net.minecraft.core.Vec3D var11 = var5.getIntermediateWithZValue(var6, this.getMinZ());
		net.minecraft.core.Vec3D var12 = var5.getIntermediateWithZValue(var6, this.getMaxZ());
	...
	private boolean isVecInsideYZBounds(net.minecraft.core.Vec3D var1) {
		return var1 != null && var1.yCoord >= this.getMinY() && var1.yCoord <= this.getMaxY() && var1.zCoord >= this.getMinZ() && var1.zCoord <= this.getMaxZ();
	}

	private boolean isVecInsideXZBounds(net.minecraft.core.Vec3D var1) {
		return var1 != null && var1.xCoord >= this.getMinX() && var1.xCoord <= this.getMaxX() && var1.zCoord >= this.getMinZ() && var1.zCoord <= this.getMaxZ();
	}

	private boolean isVecInsideXYBounds(net.minecraft.core.Vec3D var1) {
		return var1 != null && var1.xCoord >= this.getMinX() && var1.xCoord <= this.getMaxX() && var1.yCoord >= this.getMinY() && var1.yCoord <= this.getMaxY();
	}
	...
	public boolean canPlaceBlockAt(net.minecraft.world.World var1, int var2, int var3, int var4) {
		...
		return var5 == 0 || blocksList[var5].getBlockMaterial().getIsGroundCover();
	}
	...
	public void harvestBlock(net.minecraft.world.World var1, EntityPlayer var2, int var3, int var4, int var5, int var6) {
		var2.addStat(net.minecraft.achievement.stats.StatList.mineBlockStatArray[this.getBlockID()], 1);
	...
	public Block setBlockName(String var1) {
		this.setBlockName_("tile." + var1);
		return this;
	}

	public String translateBlockName() {
		return net.minecraft.achievement.stats.StatCollector.translateToLocal(this.getBlockName() + ".name");
	}
	...
	protected Block disableStats() {
		this.setEnableStats(false);
		return this;
	}

	public int getMobilityFlag() {
		return this.getBlockMaterial().getMaterialMobility();
	}

	static {
		Item.itemsList[cloth.getBlockID()] = (new net.minecraft.item.ItemCloth(cloth.getBlockID() - 256)).setItemName("cloth");
		Item.itemsList[wood.getBlockID()] = (new net.minecraft.item.ItemLog(wood.getBlockID() - 256)).setItemName("log");
		Item.itemsList[stairSingle.getBlockID()] = (new net.minecraft.item.ItemSlab(stairSingle.getBlockID() - 256)).setItemName("stoneSlab");
		Item.itemsList[sapling.getBlockID()] = (new net.minecraft.item.ItemSapling(sapling.getBlockID() - 256)).setItemName("sapling");
		Item.itemsList[leaves.getBlockID()] = (new net.minecraft.item.ItemLeaves(leaves.getBlockID() - 256)).setItemName("leaves");
		Item.itemsList[pistonBase.getBlockID()] = new ItemPiston(pistonBase.getBlockID() - 256);
		Item.itemsList[pistonStickyBase.getBlockID()] = new ItemPiston(pistonStickyBase.getBlockID() - 256);
	...
	protected void setBlockIndexInTexture(int blockIndexInTexture) {
	...
	protected void setBlockResistance(float blockResistance) {
		this.blockResistance = blockResistance;
	}

	protected boolean isBlockConstructorCalled() {
		return blockConstructorCalled;
	}

	protected void setBlockConstructorCalled(boolean blockConstructorCalled) {
		this.blockConstructorCalled = blockConstructorCalled;
	}

	protected boolean isEnableStats() {
		return enableStats;
	}

	protected void setEnableStats(boolean enableStats) {
	...
	protected void setMinZ(double minZ) {
		this.minZ = minZ;
	}
	...
	protected void setStepSound_(StepSound stepSound) {
	...
	protected void setBlockParticleGravity(float blockParticleGravity) {
	...
	protected void setSlipperiness(float slipperiness) {
		this.slipperiness = slipperiness;
	}

	protected void setBlockName_(String blockName) {
