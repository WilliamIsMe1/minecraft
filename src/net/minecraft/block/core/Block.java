...
public class Block {
	...
	public boolean shouldSideBeRendered(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		return var5 == 0 && this.getMinY() > 0.0D ? true : (var5 == 1 && this.getMaxY() < 1.0D ? true : (var5 == 2 && this.getMinZ() > 0.0D ? true : (var5 == 3 && this.getMaxZ() < 1.0D ? true : (var5 == 4 && this.getMinX() > 0.0D ? true : (var5 == 5 && this.getMaxX() < 1.0D ? true : !var1.isBlockOpaqueCube(var2, var3, var4))))));
	}
	...
	public net.minecraft.misc.MovingObjectPosition collisionRayTrace(net.minecraft.world.World var1, int var2, int var3, int var4, net.minecraft.core.Vec3D var5, net.minecraft.core.Vec3D var6) {
	...
	private boolean isVecInsideYZBounds(net.minecraft.core.Vec3D var1) {
		return var1 == null ? false : var1.yCoord >= this.getMinY() && var1.yCoord <= this.getMaxY() && var1.zCoord >= this.getMinZ() && var1.zCoord <= this.getMaxZ();
	}

	private boolean isVecInsideXZBounds(net.minecraft.core.Vec3D var1) {
		return var1 == null ? false : var1.xCoord >= this.getMinX() && var1.xCoord <= this.getMaxX() && var1.zCoord >= this.getMinZ() && var1.zCoord <= this.getMaxZ();
	}

	private boolean isVecInsideXYBounds(net.minecraft.core.Vec3D var1) {
		return var1 == null ? false : var1.xCoord >= this.getMinX() && var1.xCoord <= this.getMaxX() && var1.yCoord >= this.getMinY() && var1.yCoord <= this.getMaxY();
	}
