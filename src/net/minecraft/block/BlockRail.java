...
public class BlockRail extends Block {
	...
	private void func_4031_h(net.minecraft.world.World var1, int var2, int var3, int var4, boolean var5) {
		if(!var1.multiplayerWorld) {
			(new RailLogic(this, var1, var2, var3, var4)).func_792_a(var1.isBlockIndirectlyGettingPowered(var2, var3, var4), var5);
		}
	}

	private boolean func_27044_a(net.minecraft.world.World var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
		if(var7 >= 8) {
			return false;
		} else {
			int var8 = var5 & 7;
	...
	public static boolean isPoweredBlockRail(BlockRail var0) {
