...
public class BlockPistonMoving extends BlockContainer {
	...
	public void setBlockBoundsBasedOnState(net.minecraft.block.IBlockAccess var1, int var2, int var3, int var4) {
		...
		if(var5 != null) {
			...
			this.minX = var6.minX - (double)((float) net.minecraft.client.render.PistonBlockTextures.field_31056_b[var8] * var7);
			this.minY = var6.minY - (double)((float) net.minecraft.client.render.PistonBlockTextures.field_31059_c[var8] * var7);
			this.minZ = var6.minZ - (double)((float) net.minecraft.client.render.PistonBlockTextures.field_31058_d[var8] * var7);
			this.maxX = var6.maxX - (double)((float) net.minecraft.client.render.PistonBlockTextures.field_31056_b[var8] * var7);
			this.maxY = var6.maxY - (double)((float) net.minecraft.client.render.PistonBlockTextures.field_31059_c[var8] * var7);
			this.maxZ = var6.maxZ - (double)((float) net.minecraft.client.render.PistonBlockTextures.field_31058_d[var8] * var7);
		}
