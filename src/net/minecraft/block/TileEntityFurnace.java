...
public class TileEntityFurnace extends TileEntity implements IInventory {
	private net.minecraft.item.ItemStack[] furnaceItemStacks = new net.minecraft.item.ItemStack[3];
	...
	public void readFromNBT(net.minecraft.util.nbt.NBTTagCompound var1) {
		...
		net.minecraft.util.nbt.NBTTagList var2 = var1.getTagList("Items");
		this.furnaceItemStacks = new net.minecraft.item.ItemStack[this.getSizeInventory()];

		for(int var3 = 0; var3 < var2.tagCount(); ++var3) {
			net.minecraft.util.nbt.NBTTagCompound var4 = (net.minecraft.util.nbt.NBTTagCompound)var2.tagAt(var3);
			byte var5 = var4.getByte("Slot");
			if(var5 >= 0 && var5 < this.furnaceItemStacks.length) {
				this.furnaceItemStacks[var5] = new net.minecraft.item.ItemStack(var4);
			}
		}
	...
	private boolean canSmelt() {
		if(this.furnaceItemStacks[0] == null) {
			...
			net.minecraft.item.ItemStack var1 = net.minecraft.item.FurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0].getItem().shiftedIndex);
	...
	public void smeltItem() {
		if(this.canSmelt()) {
			net.minecraft.item.ItemStack var1 = FurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0].getItem().shiftedIndex);
	...
	private int getItemBurnTime(ItemStack var1) {
		if(var1 == null) {
			...
			return var2 < 256 && net.minecraft.block.Block.blocksList[var2].blockMaterial == Material.wood ? 300 : (var2 == net.minecraft.item.Item.stick.shiftedIndex ? 100 : (var2 == net.minecraft.item.Item.coal.shiftedIndex ? 1600 : (var2 == net.minecraft.item.Item.bucketLava.shiftedIndex ? 20000 : (var2 == Block.sapling.blockID ? 100 : 0))));
		}
	}
