...
import net.minecraft.util.json.J_InvalidSyntaxException;
import net.minecraft.util.json.J_JdomParser;
import net.minecraft.util.json.J_JsonNode;
import net.minecraft.util.json.J_JsonRootNode;
import net.minecraft.util.json.J_JsonStringNode;
...
public class StatFileWriter {
	...
	public static Map func_27177_a(String var0) {
		...
		try {
			...
			while(var6.hasNext()) {
				net.minecraft.util.json.J_JsonNode var7 = (net.minecraft.util.json.J_JsonNode)var6.next();
	...
	public boolean hasAchievementUnlocked(net.minecraft.achievement.Achievement var1) {
