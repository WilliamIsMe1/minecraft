...
public class SaveFormatOld implements ISaveFormat {
	...
	public List func_22176_b() {
		...
		for(int var2 = 0; var2 < 5; ++var2) {
			...
			net.minecraft.world.WorldInfo var4 = this.func_22173_b(var3);
			if(var4 != null) {
	...
	public net.minecraft.world.WorldInfo func_22173_b(String var1) {
		...
		if(!var2.exists()) {
			...
			net.minecraft.util.nbt.NBTTagCompound var5;
			if(var3.exists()) {
				try {
	...
	public void func_22170_a(String var1, String var2) {
		...
		if(var3.exists()) {
			...
			if(var4.exists()) {
				try {
					net.minecraft.util.nbt.NBTTagCompound var5 = CompressedStreamTools.func_1138_a(new FileInputStream(var4));
