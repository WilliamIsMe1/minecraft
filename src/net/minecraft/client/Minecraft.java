...
import net.minecraft.client.render.gui.GuiChat;
import net.minecraft.client.render.gui.GuiConflictWarning;
import net.minecraft.client.render.gui.GuiConnecting;
import net.minecraft.client.render.gui.GuiErrorScreen;
import net.minecraft.client.render.gui.GuiGameOver;
import net.minecraft.client.render.gui.GuiIngame;
import net.minecraft.client.render.gui.GuiIngameMenu;
import net.minecraft.client.render.gui.GuiInventory;
import net.minecraft.client.render.gui.GuiMainMenu;
...
import net.minecraft.achievement.stats.StatStringFormatKeyInv;
import net.minecraft.misc.Teleporter;
import net.minecraft.client.render.Tessellator;
import net.minecraft.client.render.fx.TextureCompassFX;
import net.minecraft.client.render.fx.TextureFlamesFX;
import net.minecraft.client.render.fx.TextureLavaFX;
import net.minecraft.client.render.fx.TextureLavaFlowFX;
import net.minecraft.client.render.fx.TexturePackList;
import net.minecraft.client.render.fx.TexturePortalFX;
import net.minecraft.client.render.fx.TextureWatchFX;
