...
public class RenderPlayer extends RenderLiving {
	private net.minecraft.client.render.ModelBiped modelBipedMain = (net.minecraft.client.render.ModelBiped)this.mainModel;
	private net.minecraft.client.render.ModelBiped modelArmorChestplate = new net.minecraft.client.render.ModelBiped(1.0F);
	private net.minecraft.client.render.ModelBiped modelArmor = new net.minecraft.client.render.ModelBiped(0.5F);
	private static final String[] armorFilenamePrefix = new String[]{"cloth", "chain", "iron", "diamond", "gold"};

	public RenderPlayer() {
		super(new net.minecraft.client.render.ModelBiped(0.0F), 0.5F);
	}

	protected boolean setArmorModel(net.minecraft.entity.EntityPlayer var1, int var2, float var3) {
		net.minecraft.item.ItemStack var4 = var1.inventory.armorItemInSlot(3 - var2);
		if(var4 != null) {
			net.minecraft.item.Item var5 = var4.getItem();
			if(var5 instanceof net.minecraft.item.ItemArmor) {
				net.minecraft.item.ItemArmor var6 = (ItemArmor)var5;
	...
	public void renderPlayer(net.minecraft.entity.EntityPlayer var1, double var2, double var4, double var6, float var8, float var9) {
		net.minecraft.item.ItemStack var10 = var1.inventory.getCurrentItem();
	...
	protected void renderName(net.minecraft.entity.EntityPlayer var1, double var2, double var4, double var6) {
	...
	protected void renderSpecials(net.minecraft.entity.EntityPlayer var1, float var2) {
		net.minecraft.item.ItemStack var3 = var1.inventory.armorItemInSlot(3);
		if(var3 != null && var3.getItem().shiftedIndex < 256) {
			GL11.glPushMatrix();
			this.modelBipedMain.bipedHead.postRender(1.0F / 16.0F);
			if(RenderBlocks.renderItemIn3d(net.minecraft.block.Block.blocksList[var3.itemID].getRenderType())) {
		...
		net.minecraft.item.ItemStack var21 = var1.inventory.getCurrentItem();
		if(var21 != null) {
			GL11.glPushMatrix();
			...
			if(var1.fishEntity != null) {
				var21 = new ItemStack(net.minecraft.item.Item.stick);
			}
			...
			} else if(net.minecraft.item.Item.itemsList[var21.itemID].isFull3D()) {
				var5 = 10.0F / 16.0F;
	...
	protected void func_186_b(net.minecraft.entity.EntityPlayer var1, float var2) {
	...
	protected void func_22016_b(net.minecraft.entity.EntityPlayer var1, double var2, double var4, double var6) {
	...
	protected void func_22017_a(net.minecraft.entity.EntityPlayer var1, float var2, float var3, float var4) {
		if(var1.isEntityAlive() && var1.isPlayerSleeping()) {
	...
	protected void passSpecialRender(net.minecraft.entity.EntityLiving var1, double var2, double var4, double var6) {
		this.renderName((net.minecraft.entity.EntityPlayer)var1, var2, var4, var6);
	}

	protected void preRenderCallback(net.minecraft.entity.EntityLiving var1, float var2) {
		this.func_186_b((net.minecraft.entity.EntityPlayer)var1, var2);
	}

	protected boolean shouldRenderPass(net.minecraft.entity.EntityLiving var1, int var2, float var3) {
		return this.setArmorModel((net.minecraft.entity.EntityPlayer)var1, var2, var3);
	}

	protected void renderEquippedItems(net.minecraft.entity.EntityLiving var1, float var2) {
		this.renderSpecials((net.minecraft.entity.EntityPlayer)var1, var2);
	}

	protected void rotateCorpse(net.minecraft.entity.EntityLiving var1, float var2, float var3, float var4) {
		this.func_22017_a((net.minecraft.entity.EntityPlayer)var1, var2, var3, var4);
	}

	protected void func_22012_b(net.minecraft.entity.EntityLiving var1, double var2, double var4, double var6) {
		this.func_22016_b((net.minecraft.entity.EntityPlayer)var1, var2, var4, var6);
	}

	public void doRenderLiving(EntityLiving var1, double var2, double var4, double var6, float var8, float var9) {
		this.renderPlayer((net.minecraft.entity.EntityPlayer)var1, var2, var4, var6, var8, var9);
	}
