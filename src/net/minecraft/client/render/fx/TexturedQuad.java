...
public class TexturedQuad {
	...
	public TexturedQuad(net.minecraft.client.render.PositionTextureVertex[] var1) {
		this.nVertices = 0;
	...
	public TexturedQuad(net.minecraft.client.render.PositionTextureVertex[] var1, int var2, int var3, int var4, int var5) {
		this(var1);
	...
	public void flipFace() {
		net.minecraft.client.render.PositionTextureVertex[] var1 = new net.minecraft.client.render.PositionTextureVertex[this.vertexPositions.length];
