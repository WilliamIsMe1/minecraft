...
import net.minecraft.achievement.stats.SorterStatsItem;
...
public class GuiSlotStatsItem extends GuiSlotStats {
	...
	public GuiSlotStatsItem(GuiStats var1) {
		...
		for (Object o : StatList.field_25186_c) {
			StatCrafting var3 = (StatCrafting) o;
			boolean var4 = false;
			int var5 = var3.func_25072_b();
			if (GuiStats.func_27142_c(var1).writeStat(var3) > 0) {
				var4 = true;
			} else if (StatList.breakItemStatArray[var5] != null && GuiStats.func_27142_c(var1).writeStat(StatList.breakItemStatArray[var5]) > 0) {
				var4 = true;
	...
	protected void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5) {
		...
		this.func_27265_a((StatCrafting)StatList.breakItemStatArray[var7], var2 + 115, var3, var1 % 2 == 0);
		this.func_27265_a((StatCrafting)StatList.craftItemStatArray[var7], var2 + 165, var3, var1 % 2 == 0);
