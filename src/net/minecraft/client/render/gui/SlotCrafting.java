...
public class SlotCrafting extends Slot {
	private final net.minecraft.item.IInventory craftMatrix;
	private net.minecraft.entity.EntityPlayer thePlayer;

	public SlotCrafting(EntityPlayer var1, net.minecraft.item.IInventory var2, IInventory var3, int var4, int var5, int var6) {
	...
	public void onPickupFromSlot(net.minecraft.item.ItemStack var1) {
		...
		if(var1.itemID == net.minecraft.block.Block.workbench.blockID) {
			this.thePlayer.addStat(net.minecraft.achievement.AchievementList.buildWorkBench, 1);
		} else if(var1.itemID == net.minecraft.item.Item.pickaxeWood.shiftedIndex) {
		...
		} else if(var1.itemID == net.minecraft.item.Item.hoeWood.shiftedIndex) {
			this.thePlayer.addStat(net.minecraft.achievement.AchievementList.buildHoe, 1);
		} else if(var1.itemID == net.minecraft.item.Item.bread.shiftedIndex) {
			this.thePlayer.addStat(net.minecraft.achievement.AchievementList.makeBread, 1);
		} else if(var1.itemID == net.minecraft.item.Item.cake.shiftedIndex) {
			this.thePlayer.addStat(net.minecraft.achievement.AchievementList.bakeCake, 1);
		} else if(var1.itemID == net.minecraft.item.Item.pickaxeStone.shiftedIndex) {
