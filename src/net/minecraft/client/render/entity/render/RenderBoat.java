...
import net.minecraft.client.render.entity.model.ModelBoat;
...
public class RenderBoat extends Render {
	...
	public void func_157_a(net.minecraft.entity.EntityBoat var1, double var2, double var4, double var6, float var8, float var9) {
		GL11.glPushMatrix();
