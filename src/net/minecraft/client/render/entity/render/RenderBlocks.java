...
public class RenderBlocks {
	...
	public boolean renderBlockRedstoneWire(Block var1, int var2, int var3, int var4) {
		...
		if(!this.blockAccess.isBlockNormalCube(var2, var3 + 1, var4)) {
			...
			var19 = (double)((float)var14 / 256.0F);
			var21 = (double)(((float)var14 + 15.99F) / 256.0F);
			if(this.blockAccess.isBlockNormalCube(var2 - 1, var3, var4) && this.blockAccess.getBlockId(var2 - 1, var3 + 1, var4) == Block.redstoneWire.getBlockID()) {
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
			...
			if(this.blockAccess.isBlockNormalCube(var2, var3, var4 - 1) && this.blockAccess.getBlockId(var2, var3 + 1, var4 - 1) == Block.redstoneWire.getBlockID()) {
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
	...
	public boolean renderBlockFence(Block var1, int var2, int var3, int var4) {
		...
		boolean var8 = false;
		boolean var9 = false;
		if(this.blockAccess.getBlockId(var2 - 1, var3, var4) == var1.getBlockID() || this.blockAccess.getBlockId(var2 + 1, var3, var4) == var1.getBlockID()) {
			var8 = true;
		}

		if(this.blockAccess.getBlockId(var2, var3, var4 - 1) == var1.getBlockID() || this.blockAccess.getBlockId(var2, var3, var4 + 1) == var1.getBlockID()) {
			var9 = true;
		}

		boolean var10 = this.blockAccess.getBlockId(var2 - 1, var3, var4) == var1.getBlockID();
		boolean var11 = this.blockAccess.getBlockId(var2 + 1, var3, var4) == var1.getBlockID();
		boolean var12 = this.blockAccess.getBlockId(var2, var3, var4 - 1) == var1.getBlockID();
		boolean var13 = this.blockAccess.getBlockId(var2, var3, var4 + 1) == var1.getBlockID();
		if(!var8 && !var9) {
			var8 = true;
		}
