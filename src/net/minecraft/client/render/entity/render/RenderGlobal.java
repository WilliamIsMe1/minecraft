...
import net.minecraft.entity.fx.EntityBubbleFX;
import net.minecraft.entity.fx.EntityExplodeFX;
import net.minecraft.entity.fx.EntityFlameFX;
import net.minecraft.entity.fx.EntityFootStepFX;
import net.minecraft.entity.fx.EntityHeartFX;
import net.minecraft.entity.fx.EntityLavaFX;
import net.minecraft.entity.living.EntityLiving;
import net.minecraft.entity.fx.EntityNoteFX;
import net.minecraft.entity.living.EntityPlayer;
import net.minecraft.entity.fx.EntityPortalFX;
import net.minecraft.entity.fx.EntityReddustFX;
import net.minecraft.client.render.EntityRenderer;
import net.minecraft.entity.fx.EntitySlimeFX;
import net.minecraft.entity.fx.EntitySmokeFX;
import net.minecraft.entity.fx.EntitySnowShovelFX;
import net.minecraft.entity.EntitySorter;
import net.minecraft.entity.fx.EntitySplashFX;
