...
public class RenderManager {
	...
	public net.minecraft.entity.EntityLiving livingPlayer;
	...
	private RenderManager() {
		...
		this.entityRenderMap.put(EntityPig.class, new RenderPig(new net.minecraft.client.render.ModelPig(), new ModelPig(0.5F), 0.7F));
		...
		this.entityRenderMap.put(EntityZombie.class, new RenderBiped(new net.minecraft.client.render.ModelZombie(), 0.5F));
		this.entityRenderMap.put(EntitySlime.class, new RenderSlime(new net.minecraft.client.render.ModelSlime(16), new ModelSlime(0), 0.25F));
		...
		this.entityRenderMap.put(net.minecraft.entity.EntityLiving.class, new RenderLiving(new ModelBiped(), 0.5F));
		this.entityRenderMap.put(net.minecraft.entity.Entity.class, new RenderEntity());
		this.entityRenderMap.put(EntityPainting.class, new RenderPainting());
		this.entityRenderMap.put(EntityArrow.class, new RenderArrow());
		this.entityRenderMap.put(EntitySnowball.class, new RenderSnowball(net.minecraft.item.Item.snowball.getIconFromDamage(0)));
		...
		while(var1.hasNext()) {
			net.minecraft.client.render.Render var2 = (net.minecraft.client.render.Render)var1.next();
