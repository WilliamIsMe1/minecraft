...
public class RenderGlobal implements IWorldAccess {
	...
	private net.minecraft.client.render.WorldRenderer[] sortedWorldRenderers;
	private net.minecraft.client.render.WorldRenderer[] worldRenderers;
	...
	IntBuffer occlusionResult = net.minecraft.client.render.GLAllocation.createDirectIntBuffer(64);
	...
	int dummyInt0 = 0;
	int glDummyList = net.minecraft.client.render.GLAllocation.generateDisplayLists(1);
	...
	public RenderGlobal(Minecraft var1, RenderEngine var2) {
		...
		byte var3 = 64;
		this.glRenderListBase = net.minecraft.client.render.GLAllocation.generateDisplayLists(var3 * var3 * var3 * 3);
		this.occlusionEnabled = var1.getOpenGlCapsChecker().checkARBOcclusion();
		if(this.occlusionEnabled) {
			this.occlusionResult.clear();
			this.glOcclusionQueryBase = net.minecraft.client.render.GLAllocation.createDirectIntBuffer(var3 * var3 * var3);
		...
		this.starGLCallList = net.minecraft.client.render.GLAllocation.generateDisplayLists(3);
		GL11.glPushMatrix();
	...
	public void loadRenderers() {
		net.minecraft.block.Block.leaves.setGraphicsLevel(this.mc.gameSettings.fancyGraphics);
		...
		this.worldRenderers = new net.minecraft.client.render.WorldRenderer[this.renderChunksWide * this.renderChunksTall * this.renderChunksDeep];
		this.sortedWorldRenderers = new net.minecraft.client.render.WorldRenderer[this.renderChunksWide * this.renderChunksTall * this.renderChunksDeep];
		int var2 = 0;
		int var3 = 0;
		this.minBlockX = 0;
		this.minBlockY = 0;
		...
		for(var4 = 0; var4 < this.worldRenderersToUpdate.size(); ++var4) {
			((net.minecraft.client.render.WorldRenderer)this.worldRenderersToUpdate.get(var4)).needsUpdate = false;
		}
		...
		for(var4 = 0; var4 < this.renderChunksWide; ++var4) {
			for(int var5 = 0; var5 < this.renderChunksTall; ++var5) {
				for(int var6 = 0; var6 < this.renderChunksDeep; ++var6) {
					this.worldRenderers[(var6 * this.renderChunksTall + var5) * this.renderChunksWide + var4] = new net.minecraft.client.render.WorldRenderer(this.worldObj, this.tileEntities, var4 * 16, var5 * 16, var6 * 16, 16, this.glRenderListBase + var2);
					if(this.occlusionEnabled) {
		...
		if(this.worldObj != null) {
			net.minecraft.entity.EntityLiving var7 = this.mc.renderViewEntity;
			if(var7 != null) {
				...
				Arrays.sort(this.sortedWorldRenderers, new net.minecraft.entity.EntitySorter(var7));
			}
		}
	...
	public void renderEntities(Vec3D var1, net.minecraft.client.render.ICamera var2, float var3) {
		if(this.renderEntitiesStartupCounter > 0) {
			--this.renderEntitiesStartupCounter;
		} else {
			net.minecraft.block.TileEntityRenderer.instance.cacheActiveRenderInfo(this.worldObj, this.renderEngine, this.mc.fontRenderer, this.mc.renderViewEntity, var3);
			...
			net.minecraft.entity.EntityLiving var4 = this.mc.renderViewEntity;
			...
			net.minecraft.block.TileEntityRenderer.staticPlayerX = var4.lastTickPosX + (var4.posX - var4.lastTickPosX) * (double)var3;
			net.minecraft.block.TileEntityRenderer.staticPlayerY = var4.lastTickPosY + (var4.posY - var4.lastTickPosY) * (double)var3;
			net.minecraft.block.TileEntityRenderer.staticPlayerZ = var4.lastTickPosZ + (var4.posZ - var4.lastTickPosZ) * (double)var3;
			List var5 = this.worldObj.getLoadedEntityList();
			this.countEntitiesTotal = var5.size();

			int var6;
			net.minecraft.entity.Entity var7;
			for(var6 = 0; var6 < this.worldObj.weatherEffects.size(); ++var6) {
				var7 = (net.minecraft.entity.Entity)this.worldObj.weatherEffects.get(var6);
			...
			for(var6 = 0; var6 < var5.size(); ++var6) {
				var7 = (net.minecraft.entity.Entity)var5.get(var6);
			...
			for(var6 = 0; var6 < this.tileEntities.size(); ++var6) {
				TileEntityRenderer.instance.renderTileEntity((net.minecraft.block.TileEntity)this.tileEntities.get(var6), var3);
			}
		...
		for(int var6 = 0; var6 < this.renderChunksWide; ++var6) {
			...
			for(int var9 = 0; var9 < this.renderChunksDeep; ++var9) {
				...
				for(int var12 = 0; var12 < this.renderChunksTall; ++var12) {
					...
					net.minecraft.client.render.WorldRenderer var14 = this.worldRenderers[(var9 * this.renderChunksTall + var12) * this.renderChunksWide + var6];
	...
	public int sortAndRender(net.minecraft.entity.EntityLiving var1, int var2, double var3) {
		for(int var5 = 0; var5 < 10; ++var5) {
			this.worldRenderersCheckIndex = (this.worldRenderersCheckIndex + 1) % this.worldRenderers.length;
			net.minecraft.client.render.WorldRenderer var6 = this.worldRenderers[this.worldRenderersCheckIndex];
		...
		if(this.occlusionEnabled && this.mc.gameSettings.advancedOpengl && !this.mc.gameSettings.anaglyph && var2 == 0) {
			...
			do {
					...
					if(this.sortedWorldRenderers[var23].skipAllRenderPasses()) {
						...
						if(this.sortedWorldRenderers[var23].isInFrustum && !this.sortedWorldRenderers[var23].isWaitingOnOcclusionQuery) {
							...
							if(this.cloudOffsetX % var25 == var23 % var25) {
								net.minecraft.client.render.WorldRenderer var26 = this.sortedWorldRenderers[var23];
				...
				if(this.mc.gameSettings.anaglyph) {
					if(net.minecraft.entity.EntityRenderer.anaglyphField == 0) {
	...
	private int renderSortedRenderers(int var1, int var2, int var3, double var4) {
		...
		net.minecraft.entity.EntityLiving var19 = this.mc.renderViewEntity;
		...
		for(var15 = 0; var15 < this.glRenderLists.size(); ++var15) {
			net.minecraft.client.render.WorldRenderer var16 = (net.minecraft.client.render.WorldRenderer)this.glRenderLists.get(var15);
			int var17 = -1;
	...
	public boolean updateRenderers(EntityLiving var1, boolean var2) {
		...
		if(var3) {
			...
			for(int var19 = 0; var19 < var18; ++var19) {
				net.minecraft.client.render.WorldRenderer var20 = (net.minecraft.client.render.WorldRenderer)this.worldRenderersToUpdate.get(var17 - var19);
				if(!var2) {
			...
			net.minecraft.client.render.WorldRenderer[] var6 = new net.minecraft.client.render.WorldRenderer[var4];
			ArrayList var7 = null;
			int var8 = this.worldRenderersToUpdate.size();
			int var9 = 0;

			int var10;
			net.minecraft.client.render.WorldRenderer var11;
			int var12;
			int var13;
			label169:
			for(var10 = 0; var10 < var8; ++var10) {
				var11 = (net.minecraft.client.render.WorldRenderer)this.worldRenderersToUpdate.get(var10);
				if(!var2) {
			...
			if(var7 != null) {
				...
				for(var10 = var7.size() - 1; var10 >= 0; --var10) {
					var11 = (net.minecraft.client.render.WorldRenderer)var7.get(var10);
			...
			for(var21 = var4 - 1; var21 >= 0; --var21) {
				net.minecraft.client.render.WorldRenderer var22 = var6[var21];
				if(var22 != null) {
			...
			for(var13 = this.worldRenderersToUpdate.size(); var21 != var13; ++var21) {
				net.minecraft.client.render.WorldRenderer var14 = (net.minecraft.client.render.WorldRenderer)this.worldRenderersToUpdate.get(var21);
				if(var14 != null) {
					boolean var15 = false;
	...
	public void drawBlockBreaking(net.minecraft.entity.EntityPlayer var1, MovingObjectPosition var2, int var3, net.minecraft.item.ItemStack var4, float var5) {
		...
		if(var3 == 0) {
			if(this.damagePartialTime > 0.0F) {
				...
				net.minecraft.block.Block var9 = var8 > 0 ? net.minecraft.block.Block.blocksList[var8] : null;
				GL11.glDisable(GL11.GL_ALPHA_TEST);
				...
				if(var9 == null) {
					var9 = net.minecraft.block.Block.stone;
				}
	...
	public void drawSelectionBox(net.minecraft.entity.EntityPlayer var1, MovingObjectPosition var2, int var3, ItemStack var4, float var5) {
		if(var3 == 0 && var2.typeOfHit == EnumMovingObjectType.TILE) {
			...
			if(var7 > 0) {
				net.minecraft.block.Block.blocksList[var7].setBlockBoundsBasedOnState(this.worldObj, var2.blockX, var2.blockY, var2.blockZ);
				...
				this.drawOutlinedBoundingBox(net.minecraft.block.Block.blocksList[var7].getSelectedBoundingBoxFromPool(this.worldObj, var2.blockX, var2.blockY, var2.blockZ).expand((double)var6, (double)var6, (double)var6).getOffsetBoundingBox(-var8, -var10, -var12));
			}
		...
		if(this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null) {
			...
			if(var14 * var14 + var16 * var16 + var18 * var18 <= var20 * var20) {
				if(var1.equals("bubble")) {
					...
					this.mc.effectRenderer.addEffect(new net.minecraft.entity.EntitySmokeFX(this.worldObj, var2, var4, var6, var8, var10, var12));
					...
					this.mc.effectRenderer.addEffect(new net.minecraft.entity.EntitySlimeFX(this.worldObj, var2, var4, var6, net.minecraft.item.Item.snowball));
					...
					this.mc.effectRenderer.addEffect(new EntitySlimeFX(this.worldObj, var2, var4, var6, net.minecraft.item.Item.slimeBall));
	...
	public void obtainEntitySkin(net.minecraft.entity.Entity var1) {
		var1.updateCloak();
		if(var1.skinUrl != null) {
			this.renderEngine.obtainImageData(var1.skinUrl, new net.minecraft.client.render.ImageBufferDownload());
		}
	...
	public void func_28136_a(EntityPlayer var1, int var2, int var3, int var4, int var5, int var6) {
		...
		case 1004:
			...
			break;
		case 1005:
			if(net.minecraft.item.Item.itemsList[var6] instanceof net.minecraft.item.ItemRecord) {
		...
		case 2001:
			var16 = var6 & 255;
			if(var16 > 0) {
				net.minecraft.block.Block var17 = Block.blocksList[var16];
