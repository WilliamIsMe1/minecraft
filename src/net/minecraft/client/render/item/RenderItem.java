...
public class RenderItem extends Render {
	...
	public void doRenderItem(net.minecraft.entity.EntityItem var1, double var2, double var4, double var6, float var8, float var9) {
		...
		if(var10.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[var10.itemID].getRenderType())) {
			...
			var16 = (float)(var14 % 16 * 16) / 256.0F;
			var17 = (float)(var14 % 16 * 16 + 16) / 256.0F;
			var18 = (float)(var14 / 16 * 16) / 256.0F;
			...
			for(var23 = 0; var23 < var13; ++var23) {
				...
				var15.addVertexWithUV(var20 - var21, (double)(0.0F - var22), 0.0D, (double)var17, (double)var19);
	...
	public void renderTexturedQuad(int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		var10.addVertexWithUV(var1, (double)(var2 + var6), (double)var7, (double)((float)(var3) * var8), (double)((float)(var4 + var6) * var9));
		var10.addVertexWithUV(var1 + var5, (double)(var2 + var6), (double)var7, (double)((float)(var3 + var5) * var8), (double)((float)(var4 + var6) * var9));
		var10.addVertexWithUV(var1 + var5, (double)(var2), (double)var7, (double)((float)(var3 + var5) * var8), (double)((float)(var4) * var9));
		var10.addVertexWithUV(var1, (double)(var2), (double)var7, (double)((float)(var3) * var8), (double)((float)(var4) * var9));
		var10.draw();
	}
