...
public class RenderLiving extends Render {
	protected net.minecraft.client.render.ModelBase mainModel;
	protected net.minecraft.client.render.ModelBase renderPassModel;

	public RenderLiving(net.minecraft.client.render.ModelBase var1, float var2) {
		this.mainModel = var1;
	...
	public void doRenderLiving(net.minecraft.entity.EntityLiving var1, double var2, double var4, double var6, float var8, float var9) {
		GL11.glPushMatrix();
	...
	protected float func_167_c(net.minecraft.entity.EntityLiving var1, float var2) {
	...
	protected boolean func_27005_b(net.minecraft.entity.EntityLiving var1, int var2, float var3) {
	...
	protected float getDeathMaxRotation(net.minecraft.entity.EntityLiving var1) {
		return 90.0F;
	}

	protected int getColorMultiplier(net.minecraft.entity.EntityLiving var1, float var2, float var3) {
		return 0;
	}
	...
	protected void renderLivingLabel(net.minecraft.entity.EntityLiving var1, String var2, double var3, double var5, double var7, int var9) {
