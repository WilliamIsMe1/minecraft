...
public abstract class Render {
	...
	public abstract void doRender(net.minecraft.entity.Entity var1, double var2, double var4, double var6, float var8, float var9);
	...
	private void renderShadow(net.minecraft.entity.Entity var1, double var2, double var4, double var6, float var8, float var9) {
		...
		net.minecraft.world.World var11 = this.getWorldFromRenderManager();
