...
public class RenderItem extends Render {
	...
	public void doRenderItem(net.minecraft.entity.EntityItem var1, double var2, double var4, double var6, float var8, float var9) {
		this.random.setSeed(187L);
		net.minecraft.item.ItemStack var10 = var1.item;
		GL11.glPushMatrix();
		...
		float var17;
		float var18;
		if(var10.itemID < 256 && RenderBlocks.renderItemIn3d(net.minecraft.block.Block.blocksList[var10.itemID].getRenderType())) {
			GL11.glRotatef(var12, 0.0F, 1.0F, 0.0F);
			this.loadTexture("/terrain.png");
			float var28 = 0.25F;
			if(!net.minecraft.block.Block.blocksList[var10.itemID].renderAsNormalBlock() && var10.itemID != net.minecraft.block.Block.stairSingle.blockID && net.minecraft.block.Block.blocksList[var10.itemID].getRenderType() != 16) {
				var28 = 0.5F;
			}
			...
			for(int var29 = 0; var29 < var13; ++var29) {
				...
				this.renderBlocks.renderBlockOnInventory(net.minecraft.block.Block.blocksList[var10.itemID], var10.getItemDamage(), var1.getEntityBrightness(var9));
				GL11.glPopMatrix();
			}
		} else {
			...
			if(this.field_27004_a) {
				var23 = net.minecraft.item.Item.itemsList[var10.itemID].getColorFromDamage(var10.getItemDamage());
	...
	public void drawItemIntoGui(FontRenderer var1, RenderEngine var2, int var3, int var4, int var5, int var6, int var7) {
		float var11;
		if(var3 < 256 && RenderBlocks.renderItemIn3d(net.minecraft.block.Block.blocksList[var3].getRenderType())) {
			var2.bindTexture(var2.getTexture("/terrain.png"));
			net.minecraft.block.Block var14 = Block.blocksList[var3];
			GL11.glPushMatrix();
			...
			int var15 = net.minecraft.item.Item.itemsList[var3].getColorFromDamage(var4);
	...
	public void renderItemIntoGUI(FontRenderer var1, RenderEngine var2, net.minecraft.item.ItemStack var3, int var4, int var5) {
		if(var3 != null) {
