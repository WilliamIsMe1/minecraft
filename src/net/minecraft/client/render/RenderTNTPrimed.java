...
public class RenderTNTPrimed extends Render {
	...
	public void func_153_a(net.minecraft.entity.EntityTNTPrimed var1, double var2, double var4, double var6, float var8, float var9) {
		GL11.glPushMatrix();
		...
		this.blockRenderer.renderBlockOnInventory(net.minecraft.block.Block.tnt, 0, var1.getEntityBrightness(var9));
		if(var1.fuse / 5 % 2 == 0) {
