...
public class RenderBlocks {
	...
	public void renderBlockWithoutCulling(Block var1, int var2, int var3, int var4) {
	...
	public boolean renderBlockByRenderType(Block block, int x, int y, int z) {
		...
		block.setBlockBoundsBasedOnState(this.ctx.blockAccess, x, y, z);

		return switch (var5) {
			case 0 -> this.renderStandardBlock(block, x, y, z);
			case 1 -> this.renderBlockReed(block, x, y, z);
			case 2 -> this.renderBlockTorch(block, x, y, z);
			case 3 -> this.renderBlockFire(block, x, y, z);
			case 4 -> this.renderBlockFluids(block, x, y, z);
			case 5 -> this.renderBlockRedstoneWire(block, x, y, z);
			case 6 -> this.renderBlockCrops(block, x, y, z);
			case 7 -> this.renderBlockDoor(block, x, y, z);
			case 8 -> this.renderBlockLadder(block, x, y, z);
			case 9 -> this.renderBlockMinecartTrack((BlockRail) block, x, y, z);
			case 10 -> this.renderBlockStairs(block, x, y, z);
			case 11 -> this.renderBlockFence(block, x, y, z);
			case 12 -> this.renderBlockLever(block, x, y, z);
			case 13 -> this.renderBlockCactus(block, x, y, z);
			case 14 -> this.renderBlockBed(block, x, y, z);
			case 15 -> this.renderBlockRepeater(block, x, y, z);
			case 16 -> this.func_31074_b(block, x, y, z, false);
			case 17 -> this.func_31080_c(block, x, y, z, true);
			default -> false;
		};
	}
	...
	private boolean renderBlockBed(Block var1, int var2, int var3, int var4) {
		...
		int var6 = this.ctx.blockAccess.getBlockMetadata(var2, var3, var4);
		int var7 = net.minecraft.block.BlockBed.getDirectionFromMetadata(var6);
		boolean var8 = BlockBed.isBlockFootOfBed(var6);
		float var9 = 0.5F;
		float var10 = 1.0F;
		float var11 = 0.8F;
		float var12 = 0.6F;
		float var25 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
		var5.setColorOpaque_F(var9 * var25, var9 * var25, var9 * var25);
		int var26 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 0);
		...
		float var64 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4);
		var5.setColorOpaque_F(var10 * var64, var10 * var64, var10 * var64);
		var27 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 1);
		var28 = (var27 & 15) << 4;
		int var67 = var27 & 240;
...
//			break;
		...
		if(var26 != 2 && (this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 - 1, 2))) {
			...
			this.renderEastFace(var1, var2, var3, var4, var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 2));
		}
		...
		if(var26 != 3 && (this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 + 1, 3))) {
			...
			var5.setColorOpaque_F(var11 * var66, var11 * var66, var11 * var66);
			this.flipTexture = false/* var65 == 3 */;
			this.renderWestFace(var1, var2, var3, var4, var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 3));
		}
		...
		if(var26 != 4 && (this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2 - 1, var3, var4, 4))) {
			...
			this.renderNorthFace(var1, var2, var3, var4, var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 4));
		}
		...
		if(var26 != 5 && (this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2 + 1, var3, var4, 5))) {
			...
			this.renderSouthFace(var1, var2, var3, var4, var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 5));
		}
	...
	public boolean renderBlockTorch(Block var1, int var2, int var3, int var4) {
		...
		double var12 = 0.2D;
		if(var5 == 1) {
			this.renderTorchAtAngle(var1, (double)var2 - var10, (double)var3 + var12, var4, -var8, 0.0D);
		} else if(var5 == 2) {
			this.renderTorchAtAngle(var1, (double)var2 + var10, (double)var3 + var12, var4, var8, 0.0D);
		} else if(var5 == 3) {
			this.renderTorchAtAngle(var1, var2, (double)var3 + var12, (double)var4 - var10, 0.0D, -var8);
		} else if(var5 == 4) {
			this.renderTorchAtAngle(var1, var2, (double)var3 + var12, (double)var4 + var10, 0.0D, var8);
		} else {
			this.renderTorchAtAngle(var1, var2, var3, var4, 0.0D, 0.0D);
		}
	...
	private boolean renderBlockRepeater(Block var1, int var2, int var3, int var4) {
		...
		float var35 = (float)(var2);
		float var36 = (float)(var4);
		float var37 = (float)(var4 + 1);
		float var38 = (float)(var4 + 1);
		float var39 = (float)(var4);
	...
	private boolean func_31080_c(Block var1, int var2, int var3, int var4, boolean var5) {
		...
		float var11 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
		...
		case 0:
			...
			this.renderStandardBlock(var1, var2, var3, var4);
			this.func_31076_a((float)var2 + 6.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 + 0.25F, (float)var3 + 0.25F + var12, (float)var4 + 10.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11 * 0.8F, var13);
			this.func_31076_a((float)var2 + 10.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 + 0.25F, (float)var3 + 0.25F + var12, (float)var4 + 6.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.8F, var13);
			this.func_31076_a((float)var2 + 6.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 + 0.25F, (float)var3 + 0.25F + var12, (float)var4 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11 * 0.6F, var13);
			this.func_31076_a((float)var2 + 10.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 + 0.25F, (float)var3 + 0.25F + var12, (float)var4 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.6F, var13);
			break;
		case 1:
			var1.setBlockBounds(0.0F, 12.0F / 16.0F, 0.0F, 1.0F, 1.0F, 1.0F);
			this.renderStandardBlock(var1, var2, var3, var4);
			this.func_31076_a((float)var2 + 6.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 - 0.25F + 1.0F - var12, (float)var3 - 0.25F + 1.0F, (float)var4 + 10.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11 * 0.8F, var13);
			this.func_31076_a((float)var2 + 10.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 - 0.25F + 1.0F - var12, (float)var3 - 0.25F + 1.0F, (float)var4 + 6.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.8F, var13);
			this.func_31076_a((float)var2 + 6.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 - 0.25F + 1.0F - var12, (float)var3 - 0.25F + 1.0F, (float)var4 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11 * 0.6F, var13);
			this.func_31076_a((float)var2 + 10.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 - 0.25F + 1.0F - var12, (float)var3 - 0.25F + 1.0F, (float)var4 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.6F, var13);
			break;
		case 2:
			this.field_31085_i = 1;
			this.field_31084_j = 2;
			...
			this.renderStandardBlock(var1, var2, var3, var4);
			this.func_31081_b((float)var2 + 6.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 + 0.25F, (float)var4 + 0.25F + var12, var11 * 0.6F, var13);
			this.func_31081_b((float)var2 + 10.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 + 0.25F, (float)var4 + 0.25F + var12, var11 * 0.6F, var13);
			this.func_31081_b((float)var2 + 6.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 + 0.25F, (float)var4 + 0.25F + var12, var11 * 0.5F, var13);
			this.func_31081_b((float)var2 + 10.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 + 0.25F, (float)var4 + 0.25F + var12, var11, var13);
			break;
		case 3:
			this.field_31085_i = 2;
			this.field_31084_j = 1;
			...
			this.renderStandardBlock(var1, var2, var3, var4);
			this.func_31081_b((float)var2 + 6.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 - 0.25F + 1.0F - var12, (float)var4 - 0.25F + 1.0F, var11 * 0.6F, var13);
			this.func_31081_b((float)var2 + 10.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 - 0.25F + 1.0F - var12, (float)var4 - 0.25F + 1.0F, var11 * 0.6F, var13);
			this.func_31081_b((float)var2 + 6.0F / 16.0F, (float)var2 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 - 0.25F + 1.0F - var12, (float)var4 - 0.25F + 1.0F, var11 * 0.5F, var13);
			this.func_31081_b((float)var2 + 10.0F / 16.0F, (float)var2 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 - 0.25F + 1.0F - var12, (float)var4 - 0.25F + 1.0F, var11, var13);
			break;
		case 4:
			this.field_31087_g = 1;
			this.field_31086_h = 2;
			...
			this.renderStandardBlock(var1, var2, var3, var4);
			this.func_31077_c((float)var2 + 0.25F, (float)var2 + 0.25F + var12, (float)var3 + 6.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.5F, var13);
			this.func_31077_c((float)var2 + 0.25F, (float)var2 + 0.25F + var12, (float)var3 + 10.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11, var13);
			this.func_31077_c((float)var2 + 0.25F, (float)var2 + 0.25F + var12, (float)var3 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.6F, var13);
			this.func_31077_c((float)var2 + 0.25F, (float)var2 + 0.25F + var12, (float)var3 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11 * 0.6F, var13);
			break;
		case 5:
			this.field_31087_g = 2;
			this.field_31086_h = 1;
			...
			this.renderStandardBlock(var1, var2, var3, var4);
			this.func_31077_c((float)var2 - 0.25F + 1.0F - var12, (float)var2 - 0.25F + 1.0F, (float)var3 + 6.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.5F, var13);
			this.func_31077_c((float)var2 - 0.25F + 1.0F - var12, (float)var2 - 0.25F + 1.0F, (float)var3 + 10.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11, var13);
			this.func_31077_c((float)var2 - 0.25F + 1.0F - var12, (float)var2 - 0.25F + 1.0F, (float)var3 + 6.0F / 16.0F, (float)var3 + 10.0F / 16.0F, (float)var4 + 6.0F / 16.0F, (float)var4 + 6.0F / 16.0F, var11 * 0.6F, var13);
			this.func_31077_c((float)var2 - 0.25F + 1.0F - var12, (float)var2 - 0.25F + 1.0F, (float)var3 + 10.0F / 16.0F, (float)var3 + 6.0F / 16.0F, (float)var4 + 10.0F / 16.0F, (float)var4 + 10.0F / 16.0F, var11 * 0.6F, var13);
		}
	...
	public boolean renderBlockLever(Block var1, int var2, int var3, int var4) {
		...
		for(int var25 = 0; var25 < 8; ++var25) {
			...
			if(var6 < 5) {
				...
				var21[var25].yCoord += (float)var3 + 0.5F;
				var21[var25].zCoord += (double)var4 + 0.5D;
			} else {
				var21[var25].xCoord += (double)var2 + 0.5D;
				var21[var25].yCoord += (float)var3 + 2.0F / 16.0F;
				var21[var25].zCoord += (double)var4 + 0.5D;
			}
		}
	...
	public boolean renderBlockFire(Block var1, int var2, int var3, int var4) {
		...
		double var31;
		double var33;
		if(!this.ctx.blockAccess.isBlockNormalCube(var2, var3 - 1, var4) && !Block.fire.canBlockCatchFire(this.ctx.blockAccess, var2, var3 - 1, var4)) {
			float var37 = 0.2F;
			...
			if(Block.fire.canBlockCatchFire(this.ctx.blockAccess, var2 - 1, var3, var4)) {
				var5.addVertexWithUV((float)var2 + var37, (float)var3 + var18 + var20, var4 + 1, var12, var14);
				var5.addVertexWithUV(var2, (float)(var3) + var20, var4 + 1, var12, var16);
				var5.addVertexWithUV(var2, (float)(var3) + var20, var4, var10, var16);
				var5.addVertexWithUV((float)var2 + var37, (float)var3 + var18 + var20, var4, var10, var14);
				var5.addVertexWithUV((float)var2 + var37, (float)var3 + var18 + var20, var4, var10, var14);
				var5.addVertexWithUV(var2, (float)(var3) + var20, var4, var10, var16);
				var5.addVertexWithUV(var2, (float)(var3) + var20, var4 + 1, var12, var16);
				var5.addVertexWithUV((float)var2 + var37, (float)var3 + var18 + var20, var4 + 1, var12, var14);
			...
			if(Block.fire.canBlockCatchFire(this.ctx.blockAccess, var2 + 1, var3, var4)) {
				var5.addVertexWithUV((float)(var2 + 1) - var37, (float)var3 + var18 + var20, var4, var10, var14);
				var5.addVertexWithUV(var2 + 1, (float)(var3) + var20, var4, var10, var16);
				var5.addVertexWithUV(var2 + 1, (float)(var3) + var20, var4 + 1, var12, var16);
			...
			if(Block.fire.canBlockCatchFire(this.ctx.blockAccess, var2, var3, var4 - 1)) {
				var5.addVertexWithUV(var2, (float)var3 + var18 + var20, (float)var4 + var37, var12, var14);
				var5.addVertexWithUV(var2, (float)(var3) + var20, var4, var12, var16);
				var5.addVertexWithUV(var2 + 1, (float)(var3) + var20, var4, var10, var16);
			...
			if(Block.fire.canBlockCatchFire(this.ctx.blockAccess, var2, var3, var4 + 1)) {
				...
				var5.addVertexWithUV(var2 + 1, (float)(var3) + var20, var4 + 1, var10, var16);
				var5.addVertexWithUV(var2, (float)(var3) + var20, var4 + 1, var12, var16);
				var5.addVertexWithUV(var2, (float)var3 + var18 + var20, (float)(var4 + 1) - var37, var12, var14);
				var5.addVertexWithUV(var2, (float)var3 + var18 + var20, (float)(var4 + 1) - var37, var12, var14);
				var5.addVertexWithUV(var2, (float)(var3) + var20, var4 + 1, var12, var16);
				var5.addVertexWithUV(var2 + 1, (float)(var3) + var20, var4 + 1, var10, var16);
				var5.addVertexWithUV(var2 + 1, (float)var3 + var18 + var20, (float)(var4 + 1) - var37, var10, var14);
			...
			if(Block.fire.canBlockCatchFire(this.ctx.blockAccess, var2, var3 + 1, var4)) {
				...
				if((var2 + var3 + var4 & 1) == 0) {
					var5.addVertexWithUV(var29, (float)var3 + var18, var4, var12, var14);
					var5.addVertexWithUV(var21, var3, var4, var12, var16);
					var5.addVertexWithUV(var21, var3, var4 + 1, var10, var16);
					...
					var5.addVertexWithUV(var23, var3, var4 + 1, var12, var16);
					var5.addVertexWithUV(var23, var3, var4, var10, var16);
					var5.addVertexWithUV(var31, (float)var3 + var18, var4, var10, var14);
				} else {
					var5.addVertexWithUV(var2, (float)var3 + var18, var35, var12, var14);
					var5.addVertexWithUV(var2, var3, var27, var12, var16);
					var5.addVertexWithUV(var2 + 1, var3, var27, var10, var16);
					...
					var5.addVertexWithUV(var2 + 1, var3, var25, var12, var16);
					var5.addVertexWithUV(var2, var3, var25, var10, var16);
					var5.addVertexWithUV(var2, (float)var3 + var18, var33, var10, var14);
				}
			}
		} else {
			...
			var5.addVertexWithUV(var19, var3, var4 + 1, var12, var16);
			var5.addVertexWithUV(var19, var3, var4, var10, var16);
			var5.addVertexWithUV(var27, (float)var3 + var18, var4, var10, var14);
			var5.addVertexWithUV(var29, (float)var3 + var18, var4, var12, var14);
			var5.addVertexWithUV(var21, var3, var4, var12, var16);
			var5.addVertexWithUV(var21, var3, var4 + 1, var10, var16);
			var5.addVertexWithUV(var29, (float)var3 + var18, var4 + 1, var10, var14);
			...
			var5.addVertexWithUV(var2, var3, var25, var10, var16);
			var5.addVertexWithUV(var2, (float)var3 + var18, var33, var10, var14);
			var5.addVertexWithUV(var2, (float)var3 + var18, var31, var12, var14);
			var5.addVertexWithUV(var2, var3, var23, var12, var16);
			var5.addVertexWithUV(var2 + 1, var3, var23, var10, var16);
	...
	public boolean renderBlockRedstoneWire(Block var1, int var2, int var3, int var4) {
		...
		float var8 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
		...
		boolean var26 = BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2 - 1, var3, var4, 1) || !this.ctx.blockAccess.isBlockNormalCube(var2 - 1, var3, var4) && BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2 - 1, var3 - 1, var4, -1);
		boolean var27 = BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2 + 1, var3, var4, 3) || !this.ctx.blockAccess.isBlockNormalCube(var2 + 1, var3, var4) && BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2 + 1, var3 - 1, var4, -1);
		boolean var28 = BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2, var3, var4 - 1, 2) || !this.ctx.blockAccess.isBlockNormalCube(var2, var3, var4 - 1) && BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2, var3 - 1, var4 - 1, -1);
		boolean var29 = BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2, var3, var4 + 1, 0) || !this.ctx.blockAccess.isBlockNormalCube(var2, var3, var4 + 1) && BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2, var3 - 1, var4 + 1, -1);
		if(!this.ctx.blockAccess.isBlockNormalCube(var2, var3 + 1, var4)) {
			if(this.ctx.blockAccess.isBlockNormalCube(var2 - 1, var3, var4) && BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2 - 1, var3 + 1, var4, -1)) {
				var26 = true;
			}
			...
			if(this.ctx.blockAccess.isBlockNormalCube(var2, var3, var4 - 1) && BlockRedstoneWire.isPowerProviderOrWire(this.ctx.blockAccess, var2, var3 + 1, var4 - 1, -1)) {
				var28 = true;
			}
		...
		float var31 = (float)(var2);
		float var32 = (float)(var2 + 1);
		float var33 = (float)(var4);
		...
		if(var35 == 0) {
			...
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var34, var17, var21);
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var33, var17, var19);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var33, var15, var19);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var34, var15, var21);
			var5.setColorOpaque_F(var8, var8, var8);
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var34, var17, var21 + 1.0D / 16.0D);
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var33, var17, var19 + 1.0D / 16.0D);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var33, var15, var19 + 1.0D / 16.0D);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var34, var15, var21 + 1.0D / 16.0D);
		} else if(var35 == 1) {
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var34, var17, var21);
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var33, var17, var19);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var33, var15, var19);
			...
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var34, var17, var21);
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var33, var15, var21);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var33, var15, var19);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var34, var17, var19);
			var5.setColorOpaque_F(var8, var8, var8);
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var34, var17, var21 + 1.0D / 16.0D);
			var5.addVertexWithUV(var32, (float)var3 + 0.015625F, var33, var15, var21 + 1.0D / 16.0D);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var33, var15, var19 + 1.0D / 16.0D);
			var5.addVertexWithUV(var31, (float)var3 + 0.015625F, var34, var17, var19 + 1.0D / 16.0D);
		}
	...
	public boolean renderBlockLadder(Block var1, int var2, int var3, int var4) {
		...
		double var14 = (float)var9 / 256.0F;
		double var16 = ((float)var9 + 15.99F) / 256.0F;
		int var18 = this.ctx.blockAccess.getBlockMetadata(var2, var3, var4);
		float var19 = 0.0F;
		float var20 = 0.05F;
		if(var18 == 5) {
			var5.addVertexWithUV((float)var2 + var20, (float)(var3 + 1) + var19, (float)(var4 + 1) + var19, var10, var14);
			var5.addVertexWithUV((float)var2 + var20, (float)(var3) - var19, (float)(var4 + 1) + var19, var10, var16);
			var5.addVertexWithUV((float)var2 + var20, (float)(var3) - var19, (float)(var4) - var19, var12, var16);
			var5.addVertexWithUV((float)var2 + var20, (float)(var3 + 1) + var19, (float)(var4) - var19, var12, var14);
		}

		if(var18 == 4) {
			var5.addVertexWithUV((float)(var2 + 1) - var20, (float)(var3) - var19, (float)(var4 + 1) + var19, var12, var16);
			var5.addVertexWithUV((float)(var2 + 1) - var20, (float)(var3 + 1) + var19, (float)(var4 + 1) + var19, var12, var14);
			var5.addVertexWithUV((float)(var2 + 1) - var20, (float)(var3 + 1) + var19, (float)(var4) - var19, var10, var14);
			var5.addVertexWithUV((float)(var2 + 1) - var20, (float)(var3) - var19, (float)(var4) - var19, var10, var16);
		}

		if(var18 == 3) {
			var5.addVertexWithUV((float)(var2 + 1) + var19, (float)(var3) - var19, (float)var4 + var20, var12, var16);
			var5.addVertexWithUV((float)(var2 + 1) + var19, (float)(var3 + 1) + var19, (float)var4 + var20, var12, var14);
			var5.addVertexWithUV((float)(var2) - var19, (float)(var3 + 1) + var19, (float)var4 + var20, var10, var14);
			var5.addVertexWithUV((float)(var2) - var19, (float)(var3) - var19, (float)var4 + var20, var10, var16);
		}

		if(var18 == 2) {
			var5.addVertexWithUV((float)(var2 + 1) + var19, (float)(var3 + 1) + var19, (float)(var4 + 1) - var20, var10, var14);
			var5.addVertexWithUV((float)(var2 + 1) + var19, (float)(var3) - var19, (float)(var4 + 1) - var20, var10, var16);
			var5.addVertexWithUV((float)(var2) - var19, (float)(var3) - var19, (float)(var4 + 1) - var20, var12, var16);
			var5.addVertexWithUV((float)(var2) - var19, (float)(var3 + 1) + var19, (float)(var4 + 1) - var20, var12, var14);
		}
	...
	public boolean renderBlockReed(Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		float var6 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
		int var7 = var1.colorMultiplier(this.ctx.blockAccess, var2, var3, var4);
		...
		if(var1 == Block.tallGrass) {
			long var17 = (long)(var2 * 3129871L) ^ (long)var4 * 116129781L ^ (long)var3;
		...
		this.renderCrossedSquares(var1, this.ctx.blockAccess.getBlockMetadata(var2, var3, var4), var19, var20, var15);
		return true;
	}
	...
	public boolean renderBlockCrops(Block var1, int var2, int var3, int var4) {
		...
		this.func_1245_b(var1, this.ctx.blockAccess.getBlockMetadata(var2, var3, var4), var2, (float)var3 - 1.0F / 16.0F, var4);
		return true;
	}
	...
	public void renderTorchAtAngle(Block var1, double var2, double var4, double var6, double var8, double var10) {
		...
		var12.addVertexWithUV(var2 - var36, var4 + 1.0D, var32, var16, var18);
		var12.addVertexWithUV(var2 - var36 + var8, var4 + 0.0D, var32 + var10, var16, var19);
		var12.addVertexWithUV(var2 - var36 + var8, var4 + 0.0D, var34 + var10, var17, var19);
		var12.addVertexWithUV(var2 - var36, var4 + 1.0D, var34, var17, var18);
		var12.addVertexWithUV(var2 + var36, var4 + 1.0D, var34, var16, var18);
		var12.addVertexWithUV(var2 + var8 + var36, var4 + 0.0D, var34 + var10, var16, var19);
		var12.addVertexWithUV(var2 + var8 + var36, var4 + 0.0D, var32 + var10, var17, var19);
		var12.addVertexWithUV(var2 + var36, var4 + 1.0D, var32, var17, var18);
		var12.addVertexWithUV(var28, var4 + 1.0D, var6 + var36, var16, var18);
		var12.addVertexWithUV(var28 + var8, var4 + 0.0D, var6 + var36 + var10, var16, var19);
		var12.addVertexWithUV(var30 + var8, var4 + 0.0D, var6 + var36 + var10, var17, var19);
		var12.addVertexWithUV(var30, var4 + 1.0D, var6 + var36, var17, var18);
		var12.addVertexWithUV(var30, var4 + 1.0D, var6 - var36, var16, var18);
		var12.addVertexWithUV(var30 + var8, var4 + 0.0D, var6 - var36 + var10, var16, var19);
		var12.addVertexWithUV(var28 + var8, var4 + 0.0D, var6 - var36 + var10, var17, var19);
		var12.addVertexWithUV(var28, var4 + 1.0D, var6 - var36, var17, var18);
	}
	...
	public boolean renderBlockFluids(Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		int var6 = var1.colorMultiplier(this.ctx.blockAccess, var2, var3, var4);
		float var7 = (float)(var6 >> 16 & 255) / 255.0F;
		float var8 = (float)(var6 >> 8 & 255) / 255.0F;
		float var9 = (float)(var6 & 255) / 255.0F;
		boolean var10 = var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3 + 1, var4, 1);
		boolean var11 = var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3 - 1, var4, 0);
		boolean[] var12 = new boolean[]{var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 - 1, 2), var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 + 1, 3), var1.shouldSideBeRendered(this.ctx.blockAccess, var2 - 1, var3, var4, 4), var1.shouldSideBeRendered(this.ctx.blockAccess, var2 + 1, var3, var4, 5)};
		if(!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
			...
			if(this.renderAllFaces || var10) {
				...
				float var29 = (float) BlockFluid.func_293_a(this.ctx.blockAccess, var2, var3, var4, var22);
				if(var29 > -999.0F) {
				...
				var38 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
				var5.setColorOpaque_F(var15 * var38 * var7, var15 * var38 * var8, var15 * var38 * var9);
				var5.addVertexWithUV(var2, ((float)var3 + var24), var4, var32 - (double)var37 - (double)var36, var34 - (double)var37 + (double)var36);
				var5.addVertexWithUV(var2, ((float)var3 + var25), var4 + 1, var32 - (double)var37 + (double)var36, var34 + (double)var37 + (double)var36);
				var5.addVertexWithUV((var2 + 1), ((float)var3 + var26), var4 + 1, var32 + (double)var37 + (double)var36, var34 + (double)var37 - (double)var36);
				var5.addVertexWithUV((var2 + 1), ((float)var3 + var27), var4, var32 + (double)var37 - (double)var36, var34 - (double)var37 - (double)var36);
			}

			if(this.renderAllFaces || var11) {
				float var52 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4);
			...
			for(var28 = 0; var28 < 4; var28++) {
				...
				if(this.renderAllFaces || var12[var28]) {
					...
					float var51 = var1.getBlockBrightness(this.ctx.blockAccess, var53, var3, var31);
					if(var28 < 2) {
						var51 *= var16;
					} else {
						var51 *= var17;
					...
					var5.addVertexWithUV(var39, var3, var40, var43, var49);
					var5.addVertexWithUV(var37, var3, var38, var41, var49);
				}
			}
	...
	private float func_1224_a(int var1, int var2, int var3, Material var4) {
		...
		for(int var7 = 0; var7 < 4; var7++) {
			...
			if(this.ctx.blockAccess.getBlockMaterial(var8, var2 + 1, var10) == var4) {
				return 1.0F;
			}

			Material var11 = this.ctx.blockAccess.getBlockMaterial(var8, var2, var10);
			if(var11 != var4) {
				if(!var11.isSolid()) {
					var6++;
					var5++;
				...
				int var12 = this.ctx.blockAccess.getBlockMetadata(var8, var2, var10);
				if(var12 >= 8 || var12 == 0) {
	...
	public boolean renderStandardBlock(Block var1, int var2, int var3, int var4) {
		int var5 = var1.colorMultiplier(this.ctx.blockAccess, var2, var3, var4);
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		...
		boolean var17 = true;
		boolean var18 = true;
		this.lightValueOwn = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
		this.aoLightValueXNeg = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4);
		this.aoLightValueYNeg = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4);
		this.aoLightValueZNeg = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 - 1);
		this.aoLightValueXPos = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4);
		this.aoLightValueYPos = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4);
		this.aoLightValueZPos = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 + 1);
		this.field_22338_U = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 + 1, var3 + 1, var4)];
		this.field_22359_ac = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 + 1, var3 - 1, var4)];
		this.field_22334_Y = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 + 1, var3, var4 + 1)];
		this.field_22363_aa = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 + 1, var3, var4 - 1)];
		this.field_22337_V = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 - 1, var3 + 1, var4)];
		this.field_22357_ad = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 - 1, var3 - 1, var4)];
		this.field_22335_X = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 - 1, var3, var4 - 1)];
		this.field_22333_Z = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2 - 1, var3, var4 + 1)];
		this.field_22336_W = Block.canBlockGrass[this.ctx.blockAccess.getBlockId(var2, var3 + 1, var4 + 1)];
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3 - 1, var4, 0)) {
			if(this.field_22352_G <= 0) {
				...
				--var3;
				this.field_22376_n = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4);
				this.field_22374_p = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 - 1);
				this.field_22373_q = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 + 1);
				this.field_22371_s = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4);
				if(!this.field_22361_ab && !this.field_22357_ad) {
					this.field_22377_m = this.field_22376_n;
				} else {
					this.field_22377_m = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4 - 1);
				}

				if(!this.field_22355_ae && !this.field_22357_ad) {
					this.field_22375_o = this.field_22376_n;
				} else {
					this.field_22375_o = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4 + 1);
				}

				if(!this.field_22361_ab && !this.field_22359_ac) {
					this.field_22372_r = this.field_22371_s;
				} else {
					this.field_22372_r = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4 - 1);
				}

				if(!this.field_22355_ae && !this.field_22359_ac) {
					this.field_22370_t = this.field_22371_s;
				} else {
					this.field_22370_t = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4 + 1);
				}
			...
			this.ctx.colorRedTopLeft = this.ctx.colorRedBottomLeft = this.ctx.colorRedBottomRight = this.ctx.colorRedTopRight = (var13 ? var5 : 1.0F) * 0.5F;
			this.ctx.colorGreenTopLeft = this.ctx.colorGreenBottomLeft = this.ctx.colorGreenBottomRight = this.ctx.colorGreenTopRight = (var13 ? var6 : 1.0F) * 0.5F;
			this.ctx.colorBlueTopLeft = this.ctx.colorBlueBottomLeft = this.ctx.colorBlueBottomRight = this.ctx.colorBlueTopRight = (var13 ? var7 : 1.0F) * 0.5F;
			this.ctx.colorRedTopLeft *= var9;
			this.ctx.colorGreenTopLeft *= var9;
			this.ctx.colorBlueTopLeft *= var9;
			this.ctx.colorRedBottomLeft *= var10;
			this.ctx.colorGreenBottomLeft *= var10;
			this.ctx.colorBlueBottomLeft *= var10;
			this.ctx.colorRedBottomRight *= var11;
			this.ctx.colorGreenBottomRight *= var11;
			this.ctx.colorBlueBottomRight *= var11;
			this.ctx.colorRedTopRight *= var12;
			this.ctx.colorGreenTopRight *= var12;
			this.ctx.colorBlueTopRight *= var12;
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3 + 1, var4, 1)) {
			if(this.field_22352_G <= 0) {
				...
				++var3;
				this.field_22368_v = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4);
				this.field_22364_z = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4);
				this.field_22366_x = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 - 1);
				this.field_22362_A = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 + 1);
				if(!this.field_22339_T && !this.field_22337_V) {
					this.field_22369_u = this.field_22368_v;
				} else {
					this.field_22369_u = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4 - 1);
				}

				if(!this.field_22339_T && !this.field_22338_U) {
					this.field_22365_y = this.field_22364_z;
				} else {
					this.field_22365_y = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4 - 1);
				}

				if(!this.field_22336_W && !this.field_22337_V) {
					this.field_22367_w = this.field_22368_v;
				} else {
					this.field_22367_w = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4 + 1);
				}

				if(!this.field_22336_W && !this.field_22338_U) {
					this.field_22360_B = this.field_22364_z;
				} else {
					this.field_22360_B = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4 + 1);
				}
			...
			this.ctx.colorRedTopLeft = this.ctx.colorRedBottomLeft = this.ctx.colorRedBottomRight = this.ctx.colorRedTopRight = var14 ? var5 : 1.0F;
			this.ctx.colorGreenTopLeft = this.ctx.colorGreenBottomLeft = this.ctx.colorGreenBottomRight = this.ctx.colorGreenTopRight = var14 ? var6 : 1.0F;
			this.ctx.colorBlueTopLeft = this.ctx.colorBlueBottomLeft = this.ctx.colorBlueBottomRight = this.ctx.colorBlueTopRight = var14 ? var7 : 1.0F;
			this.ctx.colorRedTopLeft *= var9;
			this.ctx.colorGreenTopLeft *= var9;
			this.ctx.colorBlueTopLeft *= var9;
			this.ctx.colorRedBottomLeft *= var10;
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 - 1, 2)) {
			if(this.field_22352_G <= 0) {
				...
				--var4;
				this.field_22358_C = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4);
				this.field_22374_p = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4);
				this.field_22366_x = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4);
				this.field_22356_D = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4);
				if(!this.field_22335_X && !this.field_22361_ab) {
					this.field_22377_m = this.field_22358_C;
				} else {
					this.field_22377_m = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3 - 1, var4);
				}

				if(!this.field_22335_X && !this.field_22339_T) {
					this.field_22369_u = this.field_22358_C;
				} else {
					this.field_22369_u = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3 + 1, var4);
				}

				if(!this.field_22363_aa && !this.field_22361_ab) {
					this.field_22372_r = this.field_22356_D;
				} else {
					this.field_22372_r = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3 - 1, var4);
				}

				if(!this.field_22363_aa && !this.field_22339_T) {
					this.field_22365_y = this.field_22356_D;
				} else {
					this.field_22365_y = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3 + 1, var4);
				}
			...
			this.ctx.colorRedTopLeft = this.ctx.colorRedBottomLeft = this.ctx.colorRedBottomRight = this.ctx.colorRedTopRight = (var15 ? var5 : 1.0F) * 0.8F;
			this.ctx.colorGreenTopLeft = this.ctx.colorGreenBottomLeft = this.ctx.colorGreenBottomRight = this.ctx.colorGreenTopRight = (var15 ? var6 : 1.0F) * 0.8F;
			this.ctx.colorBlueTopLeft = this.ctx.colorBlueBottomLeft = this.ctx.colorBlueBottomRight = this.ctx.colorBlueTopRight = (var15 ? var7 : 1.0F) * 0.8F;
			this.ctx.colorRedTopLeft *= var9;
			this.ctx.colorGreenTopLeft *= var9;
			this.ctx.colorBlueTopLeft *= var9;
			this.ctx.colorRedBottomLeft *= var10;
			...
			this.ctx.colorGreenTopRight *= var12;
			this.ctx.colorBlueTopRight *= var12;
			var19 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 2);
			this.renderEastFace(var1, var2, var3, var4, var19);
			if(fancyGrass && var19 == 3 && this.overrideBlockTexture < 0) {
				this.ctx.colorRedTopLeft *= var5;
				this.ctx.colorRedBottomLeft *= var5;
				this.ctx.colorRedBottomRight *= var5;
				this.ctx.colorRedTopRight *= var5;
				this.ctx.colorGreenTopLeft *= var6;
				this.ctx.colorGreenBottomLeft *= var6;
				this.ctx.colorGreenBottomRight *= var6;
				this.ctx.colorGreenTopRight *= var6;
				this.ctx.colorBlueTopLeft *= var7;
				this.ctx.colorBlueBottomLeft *= var7;
				this.ctx.colorBlueBottomRight *= var7;
				this.ctx.colorBlueTopRight *= var7;
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 + 1, 3)) {
			if(this.field_22352_G <= 0) {
				...
				++var4;
				this.field_22354_E = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3, var4);
				this.field_22353_F = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3, var4);
				this.field_22373_q = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4);
				this.field_22362_A = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4);
				if(!this.field_22333_Z && !this.field_22355_ae) {
					this.field_22375_o = this.field_22354_E;
				} else {
					this.field_22375_o = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3 - 1, var4);
				}

				if(!this.field_22333_Z && !this.field_22336_W) {
					this.field_22367_w = this.field_22354_E;
				} else {
					this.field_22367_w = var1.getBlockBrightness(this.ctx.blockAccess, var2 - 1, var3 + 1, var4);
				}

				if(!this.field_22334_Y && !this.field_22355_ae) {
					this.field_22370_t = this.field_22353_F;
				} else {
					this.field_22370_t = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3 - 1, var4);
				}

				if(!this.field_22334_Y && !this.field_22336_W) {
					this.field_22360_B = this.field_22353_F;
				} else {
					this.field_22360_B = var1.getBlockBrightness(this.ctx.blockAccess, var2 + 1, var3 + 1, var4);
				}
			...
			this.ctx.colorRedTopLeft = this.ctx.colorRedBottomLeft = this.ctx.colorRedBottomRight = this.ctx.colorRedTopRight = (var16 ? var5 : 1.0F) * 0.8F;
			this.ctx.colorGreenTopLeft = this.ctx.colorGreenBottomLeft = this.ctx.colorGreenBottomRight = this.ctx.colorGreenTopRight = (var16 ? var6 : 1.0F) * 0.8F;
			this.ctx.colorBlueTopLeft = this.ctx.colorBlueBottomLeft = this.ctx.colorBlueBottomRight = this.ctx.colorBlueTopRight = (var16 ? var7 : 1.0F) * 0.8F;
			this.ctx.colorRedTopLeft *= var9;
			this.ctx.colorGreenTopLeft *= var9;
			this.ctx.colorBlueTopLeft *= var9;
			this.ctx.colorRedBottomLeft *= var10;
			...
			this.ctx.colorGreenTopRight *= var12;
			this.ctx.colorBlueTopRight *= var12;
			var19 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 3);
			this.renderWestFace(var1, var2, var3, var4, var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 3));
			if(fancyGrass && var19 == 3 && this.overrideBlockTexture < 0) {
				this.ctx.colorRedTopLeft *= var5;
				this.ctx.colorRedBottomLeft *= var5;
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2 - 1, var3, var4, 4)) {
			if(this.field_22352_G <= 0) {
				...
				--var2;
				this.field_22376_n = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4);
				this.field_22358_C = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 - 1);
				this.field_22354_E = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 + 1);
				this.field_22368_v = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4);
				if(!this.field_22335_X && !this.field_22357_ad) {
					this.field_22377_m = this.field_22358_C;
				} else {
					this.field_22377_m = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4 - 1);
				}

				if(!this.field_22333_Z && !this.field_22357_ad) {
					this.field_22375_o = this.field_22354_E;
				} else {
					this.field_22375_o = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4 + 1);
				}

				if(!this.field_22335_X && !this.field_22337_V) {
					this.field_22369_u = this.field_22358_C;
				} else {
					this.field_22369_u = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4 - 1);
				}

				if(!this.field_22333_Z && !this.field_22337_V) {
					this.field_22367_w = this.field_22354_E;
				} else {
					this.field_22367_w = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4 + 1);
				}
			...
			this.ctx.colorRedTopLeft = this.ctx.colorRedBottomLeft = this.ctx.colorRedBottomRight = this.ctx.colorRedTopRight = (var17 ? var5 : 1.0F) * 0.6F;
			this.ctx.colorGreenTopLeft = this.ctx.colorGreenBottomLeft = this.ctx.colorGreenBottomRight = this.ctx.colorGreenTopRight = (var17 ? var6 : 1.0F) * 0.6F;
			this.ctx.colorBlueTopLeft = this.ctx.colorBlueBottomLeft = this.ctx.colorBlueBottomRight = this.ctx.colorBlueTopRight = (var17 ? var7 : 1.0F) * 0.6F;
			this.ctx.colorRedTopLeft *= var9;
			this.ctx.colorGreenTopLeft *= var9;
			this.ctx.colorBlueTopLeft *= var9;
			this.ctx.colorRedBottomLeft *= var10;
			...
			this.ctx.colorGreenTopRight *= var12;
			this.ctx.colorBlueTopRight *= var12;
			var19 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 4);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2 + 1, var3, var4, 5)) {
			if(this.field_22352_G <= 0) {
				...
				++var2;
				this.field_22371_s = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4);
				this.field_22356_D = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 - 1);
				this.field_22353_F = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4 + 1);
				this.field_22364_z = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4);
				if(!this.field_22359_ac && !this.field_22363_aa) {
					this.field_22372_r = this.field_22356_D;
				} else {
					this.field_22372_r = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4 - 1);
				}

				if(!this.field_22359_ac && !this.field_22334_Y) {
					this.field_22370_t = this.field_22353_F;
				} else {
					this.field_22370_t = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 - 1, var4 + 1);
				}

				if(!this.field_22338_U && !this.field_22363_aa) {
					this.field_22365_y = this.field_22356_D;
				} else {
					this.field_22365_y = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4 - 1);
				}

				if(!this.field_22338_U && !this.field_22334_Y) {
					this.field_22360_B = this.field_22353_F;
				} else {
					this.field_22360_B = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3 + 1, var4 + 1);
				}
			...
			this.ctx.colorRedTopLeft = this.ctx.colorRedBottomLeft = this.ctx.colorRedBottomRight = this.ctx.colorRedTopRight = (var18 ? var5 : 1.0F) * 0.6F;
			this.ctx.colorGreenTopLeft = this.ctx.colorGreenBottomLeft = this.ctx.colorGreenBottomRight = this.ctx.colorGreenTopRight = (var18 ? var6 : 1.0F) * 0.6F;
			this.ctx.colorBlueTopLeft = this.ctx.colorBlueBottomLeft = this.ctx.colorBlueBottomRight = this.ctx.colorBlueTopRight = (var18 ? var7 : 1.0F) * 0.6F;
			this.ctx.colorRedTopLeft *= var9;
			this.ctx.colorGreenTopLeft *= var9;
			this.ctx.colorBlueTopLeft *= var9;
			this.ctx.colorRedBottomLeft *= var10;
			...
			this.ctx.colorGreenTopRight *= var12;
			this.ctx.colorBlueTopRight *= var12;
			var19 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 5);
	...
	public boolean renderStandardBlockWithColorMultiplier(Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		...
		float var26 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
		float var27;
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3 - 1, var4, 0)) {
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 - 1, 2)) {
			...
			var28 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 2);
			this.renderEastFace(var1, var2, var3, var4, var28);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3, var4 + 1, 3)) {
			...
			var8.setColorOpaque_F(var18 * var27, var21 * var27, var24 * var27);
			var28 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 3);
			this.renderWestFace(var1, var2, var3, var4, var28);
			if(fancyGrass && var28 == 3 && this.overrideBlockTexture < 0) {
				var8.setColorOpaque_F(var18 * var27 * var5, var21 * var27 * var6, var24 * var27 * var7);
				this.renderWestFace(var1, var2, var3, var4, 38);
			}
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2 - 1, var3, var4, 4)) {
			...
			var28 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 4);
			this.renderNorthFace(var1, var2, var3, var4, var28);
			if(fancyGrass && var28 == 3 && this.overrideBlockTexture < 0) {
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2 + 1, var3, var4, 5)) {
			...
			var8.setColorOpaque_F(var19 * var27, var22 * var27, var25 * var27);
			var28 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 5);
			this.renderSouthFace(var1, var2, var3, var4, var28);
			if(fancyGrass && var28 == 3 && this.overrideBlockTexture < 0) {
				var8.setColorOpaque_F(var19 * var27 * var5, var22 * var27 * var6, var25 * var27 * var7);
				this.renderSouthFace(var1, var2, var3, var4, 38);
			}
	...
	public boolean func_1230_b(Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		...
		float var27 = var1.getBlockBrightness(this.ctx.blockAccess, var2, var3, var4);
		float var28;
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.ctx.blockAccess, var2, var3 - 1, var4, 0)) {
	...
	public boolean renderBlockDoor(Block var1, int var2, int var3, int var4) {
		...
		int var14 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 2);
		if(var14 < 0) {
		...
		var5.setColorOpaque_F(var10 * var13, var10 * var13, var10 * var13);
		var14 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 3);
		if(var14 < 0) {
			this.flipTexture = true;
			var14 = -var14;
		}
		...
		var14 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 4);
		if(var14 < 0) {
			this.flipTexture = true;
			var14 = -var14;
		}
		...
		var5.setColorOpaque_F(var11 * var13, var11 * var13, var11 * var13);
		var14 = var1.getBlockTexture(this.ctx.blockAccess, var2, var3, var4, 5);
		if(var14 < 0) {
			this.flipTexture = true;
			var14 = -var14;
		}
	...
	public void renderBottomFace(Block var1, double var2, double var4, double var6, int var8) {
		...
		if(this.enableAO) {
			...
			var9.setColorOpaque_F(this.ctx.colorRedBottomLeft, this.ctx.colorGreenBottomLeft, this.ctx.colorBlueBottomLeft);
			var9.addVertexWithUV(var28, var32, var34, var12, var16);
			var9.setColorOpaque_F(this.ctx.colorRedBottomRight, this.ctx.colorGreenBottomRight, this.ctx.colorBlueBottomRight);
			var9.addVertexWithUV(var30, var32, var34, var20, var24);
			var9.setColorOpaque_F(this.ctx.colorRedTopRight, this.ctx.colorGreenTopRight, this.ctx.colorBlueTopRight);
	...
	public static boolean renderItemIn3d(int var0) {
		return var0 == 0 || var0 == 13 || var0 == 10 || var0 == 11 || var0 == 16;
	}
}
