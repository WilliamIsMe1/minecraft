...
public class RenderMinecart extends Render {
	...
	public void func_152_a(net.minecraft.entity.EntityMinecart var1, double var2, double var4, double var6, float var8, float var9) {
		GL11.glPushMatrix();
		...
		if(var1.minecartType != 0) {
			...
			if(var1.minecartType == 1) {
				(new RenderBlocks()).renderBlockOnInventory(net.minecraft.block.Block.chest, 0, var1.getEntityBrightness(var9));
