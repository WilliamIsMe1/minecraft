...
public class ClippingHelperImpl extends ClippingHelper {
	...
	private FloatBuffer projectionMatrixBuffer = net.minecraft.client.render.GLAllocation.createDirectFloatBuffer(16);
	private FloatBuffer modelviewMatrixBuffer = net.minecraft.client.render.GLAllocation.createDirectFloatBuffer(16);
