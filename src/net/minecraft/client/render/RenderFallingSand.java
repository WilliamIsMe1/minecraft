...
public class RenderFallingSand extends Render {
	...
	public void doRenderFallingSand(net.minecraft.entity.EntityFallingSand var1, double var2, double var4, double var6, float var8, float var9) {
		GL11.glPushMatrix();
		GL11.glTranslatef((float)var2, (float)var4, (float)var6);
		this.loadTexture("/terrain.png");
		net.minecraft.block.Block var10 = Block.blocksList[var1.blockID];
