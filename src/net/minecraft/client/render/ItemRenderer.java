...
public class ItemRenderer {
	...
	public void renderItemInFirstPerson(float var1) {
		...
		if(var5 != null && var5.itemID == Item.mapItem.shiftedIndex) {
			...
			for(int var17 = 0; var17 < 2; ++var17) {
				...
				net.minecraft.client.render.Render var11 = RenderManager.instance.getEntityRenderObject(this.mc.thePlayer);
	...
	private void renderFireInFirstPerson(float var1) {
		...
		for(int var4 = 0; var4 < 2; ++var4) {
			GL11.glPushMatrix();
			int var5 = Block.fire.getBlockIndexInTexture() + var4 * 16;
			int var6 = (var5 & 15) << 4;
			int var7 = var5 & 240;
