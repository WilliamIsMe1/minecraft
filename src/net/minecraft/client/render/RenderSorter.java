...
public class RenderSorter implements Comparator {
	private net.minecraft.entity.EntityLiving baseEntity;

	public RenderSorter(EntityLiving var1) {
		this.baseEntity = var1;
	}

	public int doCompare(net.minecraft.client.render.WorldRenderer var1, net.minecraft.client.render.WorldRenderer var2) {
	...
	public int compare(Object var1, Object var2) {
		return this.doCompare((net.minecraft.client.render.WorldRenderer)var1, (WorldRenderer)var2);
	}
}
