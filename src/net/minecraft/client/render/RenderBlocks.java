...
public class RenderBlocks {
	private net.minecraft.block.IBlockAccess blockAccess;
	...
	public void renderBlockUsingTexture(net.minecraft.block.Block var1, int var2, int var3, int var4, int var5) {
		this.overrideBlockTexture = var5;
		this.renderBlockByRenderType(var1, var2, var3, var4);
		this.overrideBlockTexture = -1;
	}

	public void func_31075_a(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		this.renderAllFaces = true;
		this.renderBlockByRenderType(var1, var2, var3, var4);
		this.renderAllFaces = false;
	}

	public boolean renderBlockByRenderType(net.minecraft.block.Block block, int x, int y, int z) {
		...
		return switch (var5) {
			...
			case 9 -> this.renderBlockMinecartTrack((net.minecraft.block.BlockRail) block, x, y, z);
	...
	private boolean renderBlockBed(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		...
		var26 = net.minecraft.client.render.ModelBed.field_22280_a[var7];
		if(var8) {
			var26 = net.minecraft.client.render.ModelBed.field_22280_a[ModelBed.field_22279_b[var7]];
		}
	...
	public boolean renderBlockTorch(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		...
		if(net.minecraft.block.Block.lightValue[var1.blockID] > 0) {
			var7 = 1.0F;
		}
	...
	private boolean renderBlockRepeater(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		int var5 = this.blockAccess.getBlockMetadata(var2, var3, var4);
		int var6 = var5 & 3;
		int var7 = (var5 & 12) >> 2;
		...
		case 0:
			var18 = -0.3125D;
			var14 = net.minecraft.block.BlockRedstoneRepeater.field_22024_a[var7];
			break;
		case 1:
			var16 = 0.3125D;
			var12 = -net.minecraft.block.BlockRedstoneRepeater.field_22024_a[var7];
			break;
		case 2:
			var18 = 0.3125D;
			var14 = -net.minecraft.block.BlockRedstoneRepeater.field_22024_a[var7];
	...
	public void func_31078_d(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		this.renderAllFaces = true;
		this.func_31074_b(var1, var2, var3, var4, true);
		this.renderAllFaces = false;
	}

	private boolean func_31074_b(net.minecraft.block.Block var1, int var2, int var3, int var4, boolean var5) {
		int var6 = this.blockAccess.getBlockMetadata(var2, var3, var4);
	...
	public void func_31079_a(net.minecraft.block.Block var1, int var2, int var3, int var4, boolean var5) {
		this.renderAllFaces = true;
		this.func_31080_c(var1, var2, var3, var4, var5);
		this.renderAllFaces = false;
	}

	private boolean func_31080_c(net.minecraft.block.Block var1, int var2, int var3, int var4, boolean var5) {
		int var6 = this.blockAccess.getBlockMetadata(var2, var3, var4);
	...
	public boolean renderBlockLever(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		int var5 = this.blockAccess.getBlockMetadata(var2, var3, var4);
		int var6 = var5 & 7;
		...
		if(!var9) {
			this.overrideBlockTexture = net.minecraft.block.Block.cobblestone.blockIndexInTexture;
		}
	...
	public boolean renderBlockFire(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		...
		double var31;
		double var33;
		if(!this.blockAccess.isBlockNormalCube(var2, var3 - 1, var4) && !net.minecraft.block.Block.fire.canBlockCatchFire(this.blockAccess, var2, var3 - 1, var4)) {
			float var37 = 0.2F;
			...
			if(net.minecraft.block.Block.fire.canBlockCatchFire(this.blockAccess, var2 - 1, var3, var4)) {
			...
			if(net.minecraft.block.Block.fire.canBlockCatchFire(this.blockAccess, var2, var3, var4 - 1)) {
			...
			if(net.minecraft.block.Block.fire.canBlockCatchFire(this.blockAccess, var2, var3 + 1, var4)) {
	...
	public boolean renderBlockRedstoneWire(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		int var6 = this.blockAccess.getBlockMetadata(var2, var3, var4);
		...
		boolean var26 = net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 - 1, var3, var4, 1) || !this.blockAccess.isBlockNormalCube(var2 - 1, var3, var4) && net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 - 1, var3 - 1, var4, -1);
		boolean var27 = net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 + 1, var3, var4, 3) || !this.blockAccess.isBlockNormalCube(var2 + 1, var3, var4) && net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 + 1, var3 - 1, var4, -1);
		boolean var28 = net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3, var4 - 1, 2) || !this.blockAccess.isBlockNormalCube(var2, var3, var4 - 1) && net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3 - 1, var4 - 1, -1);
		boolean var29 = net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3, var4 + 1, 0) || !this.blockAccess.isBlockNormalCube(var2, var3, var4 + 1) && net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3 - 1, var4 + 1, -1);
		if(!this.blockAccess.isBlockNormalCube(var2, var3 + 1, var4)) {
			if(this.blockAccess.isBlockNormalCube(var2 - 1, var3, var4) && net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 - 1, var3 + 1, var4, -1)) {
				var26 = true;
			}
			...
			if(this.blockAccess.isBlockNormalCube(var2, var3, var4 - 1) && net.minecraft.block.BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3 + 1, var4 - 1, -1)) {
				var28 = true;
			}
		...
		if(!this.blockAccess.isBlockNormalCube(var2, var3 + 1, var4)) {
			...
			var19 = (double)((float)var14 / 256.0F);
			var21 = (double)(((float)var14 + 15.99F) / 256.0F);
			if(this.blockAccess.isBlockNormalCube(var2 - 1, var3, var4) && this.blockAccess.getBlockId(var2 - 1, var3 + 1, var4) == net.minecraft.block.Block.redstoneWire.blockID) {
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
			...
			if(this.blockAccess.isBlockNormalCube(var2, var3, var4 - 1) && this.blockAccess.getBlockId(var2, var3 + 1, var4 - 1) == net.minecraft.block.Block.redstoneWire.blockID) {
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
	...
	public boolean renderBlockLadder(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		int var6 = var1.getBlockTextureFromSide(0);
		if(this.overrideBlockTexture >= 0) {
			var6 = this.overrideBlockTexture;
	...
	public boolean renderBlockReed(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		...
		if(net.minecraft.entity.EntityRenderer.field_28135_a) {
		...
		if(var1 == net.minecraft.block.Block.tallGrass) {
	...
	public boolean renderBlockCrops(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		float var6 = var1.getBlockBrightness(this.blockAccess, var2, var3, var4);
	...
	public void renderTorchAtAngle(net.minecraft.block.Block var1, double var2, double var4, double var6, double var8, double var10) {
	...
	public void renderCrossedSquares(net.minecraft.block.Block var1, int var2, double var3, double var5, double var7) {
	...
	public void func_1245_b(net.minecraft.block.Block var1, int var2, double var3, double var5, double var7) {
		Tessellator var9 = Tessellator.instance;
		int var10 = var1.getBlockTextureFromSideAndMetadata(0, var2);
		if(this.overrideBlockTexture >= 0) {
			var10 = this.overrideBlockTexture;
	...
	public boolean renderBlockFluids(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		...
		if(!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
			...
			double var18 = 0.0D;
			double var20 = 1.0D;
			net.minecraft.block.Material var22 = var1.blockMaterial;
			...
			if(this.renderAllFaces || var10) {
				...
				float var29 = (float) net.minecraft.block.BlockFluid.func_293_a(this.blockAccess, var2, var3, var4, var22);
				if(var29 > -999.0F) {
	...
	private float func_1224_a(int var1, int var2, int var3, net.minecraft.block.Material var4) {
		int var5 = 0;
		float var6 = 0.0F;
		...
		for(int var7 = 0; var7 < 4; ++var7) {
			...
			if(var11 != var4) {
				...
				if(var12 >= 8 || var12 == 0) {
					var6 += net.minecraft.block.BlockFluid.getPercentAir(var12) * 10.0F;
					var5 += 10;
				}
	...
	public void renderBlockFallingSand(net.minecraft.block.Block var1, World var2, int var3, int var4, int var5) {
		float var6 = 0.5F;
		float var7 = 1.0F;
		float var8 = 0.8F;
		float var9 = 0.6F;
	...
	public boolean renderStandardBlock(net.minecraft.block.Block var1, int var2, int var3, int var4) {
	...
	public boolean renderStandardBlockWithAmbientOcclusion(net.minecraft.block.Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		this.enableAO = true;
		boolean var8 = false;
		...
		this.field_22338_U = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 + 1, var3 + 1, var4)];
		this.field_22359_ac = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 + 1, var3 - 1, var4)];
		this.field_22334_Y = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 + 1, var3, var4 + 1)];
		this.field_22363_aa = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 + 1, var3, var4 - 1)];
		this.field_22337_V = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 - 1, var3 + 1, var4)];
		this.field_22357_ad = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 - 1, var3 - 1, var4)];
		this.field_22335_X = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 - 1, var3, var4 - 1)];
		this.field_22333_Z = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2 - 1, var3, var4 + 1)];
		this.field_22336_W = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2, var3 + 1, var4 + 1)];
		this.field_22339_T = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2, var3 + 1, var4 - 1)];
		this.field_22355_ae = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2, var3 - 1, var4 + 1)];
		this.field_22361_ab = net.minecraft.block.Block.canBlockGrass[this.blockAccess.getBlockId(var2, var3 - 1, var4 - 1)];
	...
	public boolean renderStandardBlockWithColorMultiplier(net.minecraft.block.Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		this.enableAO = false;
		Tessellator var8 = Tessellator.instance;
		boolean var9 = false;
		float var10 = 0.5F;
		...
		float var24 = var12;
		float var25 = var13;
		if(var1 != net.minecraft.block.Block.grass) {
			var17 = var10 * var5;
			var18 = var12 * var5;
			var19 = var13 * var5;
			var20 = var10 * var6;
	...
	public boolean renderBlockCactus(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		int var5 = var1.colorMultiplier(this.blockAccess, var2, var3, var4);
		float var6 = (float)(var5 >> 16 & 255) / 255.0F;
		float var7 = (float)(var5 >> 8 & 255) / 255.0F;
		float var8 = (float)(var5 & 255) / 255.0F;
	...
	public boolean func_1230_b(net.minecraft.block.Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		Tessellator var8 = Tessellator.instance;
		boolean var9 = false;
		float var10 = 0.5F;
		float var11 = 1.0F;
	...
	public boolean renderBlockFence(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		boolean var5 = false;
	...
	public boolean renderBlockStairs(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		boolean var5 = false;
		int var6 = this.blockAccess.getBlockMetadata(var2, var3, var4);
		if(var6 == 0) {
	...
	public boolean renderBlockDoor(net.minecraft.block.Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		net.minecraft.block.BlockDoor var6 = (BlockDoor)var1;
		boolean var7 = false;
		float var8 = 0.5F;
		float var9 = 1.0F;
		float var10 = 0.8F;
	...
	public void renderBottomFace(net.minecraft.block.Block var1, double var2, double var4, double var6, int var8) {
		Tessellator var9 = Tessellator.instance;
		if(this.overrideBlockTexture >= 0) {
	...
	public void renderTopFace(net.minecraft.block.Block var1, double var2, double var4, double var6, int var8) {
		Tessellator var9 = Tessellator.instance;
		if(this.overrideBlockTexture >= 0) {
			var8 = this.overrideBlockTexture;
		}
	...
	public void renderEastFace(net.minecraft.block.Block var1, double var2, double var4, double var6, int var8) {
		Tessellator var9 = Tessellator.instance;
		if(this.overrideBlockTexture >= 0) {
			var8 = this.overrideBlockTexture;
		}
	...
	public void renderWestFace(net.minecraft.block.Block var1, double var2, double var4, double var6, int var8) {
		Tessellator var9 = Tessellator.instance;
		if(this.overrideBlockTexture >= 0) {
			var8 = this.overrideBlockTexture;
		}
	...
	public void renderNorthFace(net.minecraft.block.Block var1, double var2, double var4, double var6, int var8) {
		Tessellator var9 = Tessellator.instance;
		if(this.overrideBlockTexture >= 0) {
			var8 = this.overrideBlockTexture;
		}
	...
	public void renderSouthFace(net.minecraft.block.Block var1, double var2, double var4, double var6, int var8) {
		Tessellator var9 = Tessellator.instance;
		if(this.overrideBlockTexture >= 0) {
			var8 = this.overrideBlockTexture;
		}
