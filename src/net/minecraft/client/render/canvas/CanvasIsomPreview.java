package net.minecraft.client.render.canvas;

import net.minecraft.client.EnumOS1;
import net.minecraft.client.OsMap;
import net.minecraft.client.render.TerrainTextureManager;
...
public class CanvasIsomPreview extends Canvas implements KeyListener, MouseListener, MouseMotionListener, Runnable {
	...
	private net.minecraft.isom.IsoImageBuffer[][] imageBuffers = new net.minecraft.isom.IsoImageBuffer[64][64];
	...
	public CanvasIsomPreview() {
		for(int var1 = 0; var1 < 64; ++var1) {
			for(int var2 = 0; var2 < 64; ++var2) {
				this.imageBuffers[var1][var2] = new net.minecraft.isom.IsoImageBuffer((net.minecraft.world.World)null, var1, var2);
			}
		}
	...
	private net.minecraft.isom.IsoImageBuffer getImageBuffer(int var1, int var2) {
		int var3 = var1 & 63;
		int var4 = var2 & 63;
		net.minecraft.isom.IsoImageBuffer var5 = this.imageBuffers[var3][var4];
	...
	public void run() {
		...
		while(this.running) {
			net.minecraft.isom.IsoImageBuffer var2 = null;
			List var3 = this.imageBufferList;
			synchronized(var3) {
				if(this.imageBufferList.size() > 0) {
					var2 = (net.minecraft.isom.IsoImageBuffer)this.imageBufferList.remove(0);
				}
			}
