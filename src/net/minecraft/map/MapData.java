...
public class MapData extends MapDataBase {
	...
	public void readFromNBT(net.minecraft.util.nbt.NBTTagCompound var1) {
		...
		this.yCenter = var1.getInteger("zCenter");
		...
		short width = var1.getShort("width");
		short height = var1.getShort("height");
		if(width == 128 && height == 128) {
			...
			for(int i = 0; i < height; ++i) {
				...
				for (int j = 0; j < width; ++j) {
					int var10 = j + var5;
					this.colors[var10 + var8 * 128] = var4[j + i * width];
				}
			}
		}
	...
	public void writeToNBT(NBTTagCompound var1) {
		...
		var1.setInteger("zCenter", this.yCenter);
	...
	public void func_28169_a(EntityPlayer var1, ItemStack var2) {
		...
		for(int var14 = 0; var14 < this.field_28174_h.size(); ++var14) {
			...
			if(!var4.entityplayerObj.isDead && var4.entityplayerObj.inventory.func_28018_c(var2)) {
				...
				float var6 = (float)(var4.entityplayerObj.posZ - (double)this.yCenter) / (float)(1 << this.scale);
				byte var7 = 64;
				byte var8 = 64;
