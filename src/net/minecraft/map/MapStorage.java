			...
			if(this.field_28191_a != null) {
				try {
					...
					if(var4 != null && var4.exists()) {
						...
						net.minecraft.util.nbt.NBTTagCompound var6 = CompressedStreamTools.func_1138_a(var5);
						var5.close();
	...
	private void saveData(MapDataBase var1) {
		if(this.field_28191_a != null) {
			try {
				...
				if(var2 != null) {
					net.minecraft.util.nbt.NBTTagCompound var3 = new net.minecraft.util.nbt.NBTTagCompound();
	...
	public int getUniqueDataId(String var1) {
		...
		if(this.field_28191_a == null) {
			...
			try {
				...
				if(var3 != null) {
					net.minecraft.util.nbt.NBTTagCompound var4 = new NBTTagCompound();
