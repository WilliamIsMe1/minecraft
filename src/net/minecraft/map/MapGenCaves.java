		...
		for(boolean var26 = var23.nextInt(6) == 0; var13 < var14; ++var13) {
			...
			if(var52 || var23.nextInt(4) != 0) {
				...
				if(var4 >= var17 - 16.0D - var27 * 2.0D && var8 >= var19 - 16.0D - var27 * 2.0D && var4 <= var17 + 16.0D + var27 * 2.0D && var8 <= var19 + 16.0D + var27 * 2.0D) {
					int var53 = net.minecraft.core.MathHelper.floor_double(var4 - var27) - var1 * 16 - 1;
					int var34 = net.minecraft.core.MathHelper.floor_double(var4 + var27) - var1 * 16 + 1;
					int var54 = net.minecraft.core.MathHelper.floor_double(var6 - var29) - 1;
					int var36 = net.minecraft.core.MathHelper.floor_double(var6 + var29) + 1;
					int var55 = net.minecraft.core.MathHelper.floor_double(var8 - var27) - var2 * 16 - 1;
						...
						for(int var41 = var55; !var56 && var41 < var38; ++var41) {
							for(int var42 = var36 + 1; !var56 && var42 >= var54 - 1; --var42) {
								...
								if(var42 >= 0 && var42 < 128) {
									if(var3[var43] == net.minecraft.block.Block.waterMoving.blockID || var3[var43] == net.minecraft.block.Block.waterStill.blockID) {
										var56 = true;
									}
								...
								if(var57 * var57 + var44 * var44 < 1.0D) {
									for(int var48 = var36 - 1; var48 >= var54; --var48) {
										...
										if(var49 > -0.7D && var57 * var57 + var49 * var49 + var44 * var44 < 1.0D) {
											...
											if(var51 == net.minecraft.block.Block.grass.blockID) {
												var47 = true;
											}

											if(var51 == net.minecraft.block.Block.stone.blockID || var51 == net.minecraft.block.Block.dirt.blockID || var51 == net.minecraft.block.Block.grass.blockID) {
												if(var48 < 10) {
													var3[var46] = (byte) net.minecraft.block.Block.lavaMoving.blockID;
												} else {
													var3[var46] = 0;
													if(var47 && var3[var46 - 1] == net.minecraft.block.Block.dirt.blockID) {
