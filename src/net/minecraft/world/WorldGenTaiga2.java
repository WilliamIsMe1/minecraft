			...
			if(!var10) {
				...
				if((var11 == net.minecraft.block.Block.grass.blockID || var11 == net.minecraft.block.Block.dirt.blockID) && var4 < 128 - var6 - 1) {
					...
					for(var15 = 0; var15 <= var8; ++var15) {
						...
						for(var17 = var3 - var21; var17 <= var3 + var21; ++var17) {
							...
							for(int var19 = var5 - var21; var19 <= var5 + var21; ++var19) {
								...
								if((Math.abs(var18) != var21 || Math.abs(var20) != var21 || var21 <= 0) && !net.minecraft.block.Block.opaqueCubeLookup[var1.getBlockId(var17, var16, var19)]) {
									var1.setBlockAndMetadata(var17, var16, var19, net.minecraft.block.Block.leaves.blockID, 1);
								}
							}
						}
					...
					for(var16 = 0; var16 < var6 - var15; ++var16) {
						...
						if(var17 == 0 || var17 == net.minecraft.block.Block.leaves.blockID) {
