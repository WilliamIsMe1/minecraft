...
public class ChunkProviderGenerate implements net.minecraft.world.IChunkProvider {
	private Random rand;
							...
							for(int var52 = 0; var52 < 4; ++var52) {
								...
								if(var13 * 8 + var32 < var7) {
									if(var53 < 0.5D && var13 * 8 + var32 >= var7 - 1) {
										var55 = net.minecraft.block.Block.ice.blockID;
									} else {
										var55 = net.minecraft.block.Block.waterStill.blockID;
									}
								}

								if(var48 > 0.0D) {
									var55 = net.minecraft.block.Block.stone.blockID;
								}
			...
			for(int var9 = 0; var9 < 16; ++var9) {
				...
				for(int var17 = 127; var17 >= 0; --var17) {
					...
					if(var17 <= 0 + this.rand.nextInt(5)) {
						var3[var18] = (byte) net.minecraft.block.Block.bedrock.blockID;
					} else {
						byte var19 = var3[var18];
						if(var19 == 0) {
							var14 = -1;
						} else if(var19 == net.minecraft.block.Block.stone.blockID) {
							if(var14 == -1) {
								if(var13 <= 0) {
									var15 = 0;
									var16 = (byte) net.minecraft.block.Block.stone.blockID;
									...
									if(var12) {
										var16 = (byte) net.minecraft.block.Block.gravel.blockID;
									}

									if(var11) {
										var15 = (byte) net.minecraft.block.Block.sand.blockID;
									}

									if(var11) {
										var16 = (byte) net.minecraft.block.Block.sand.blockID;
									}
								}

								if(var17 < var5 && var15 == 0) {
									var15 = (byte) net.minecraft.block.Block.waterStill.blockID;
								}
								...
								--var14;
								var3[var18] = var16;
								if(var14 == 0 && var16 == net.minecraft.block.Block.sand.blockID) {
									var14 = this.rand.nextInt(4);
									var16 = (byte) net.minecraft.block.Block.sandStone.blockID;
								}
							}
						}
					}
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		if(this.rand.nextInt(4) == 0) {
			...
			(new net.minecraft.world.WorldGenLakes(net.minecraft.block.Block.waterStill.blockID)).generate(this.worldObj, this.rand, var13, var14, var15);
		}
		...
		if(this.rand.nextInt(8) == 0) {
			...
			if(var14 < 64 || this.rand.nextInt(10) == 0) {
				(new WorldGenLakes(net.minecraft.block.Block.lavaStill.blockID)).generate(this.worldObj, this.rand, var13, var14, var15);
			}
		}
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.rand.nextInt(128);
			var16 = var5 + this.rand.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.dirt.blockID, 32)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 10; ++var13) {
			...
			var15 = this.rand.nextInt(128);
			var16 = var5 + this.rand.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.gravel.blockID, 32)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.rand.nextInt(128);
			var16 = var5 + this.rand.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreCoal.blockID, 16)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var16 = var5 + this.rand.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreIron.blockID, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 2; ++var13) {
			...
			var16 = var5 + this.rand.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreGold.blockID, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 8; ++var13) {
			...
			var16 = var5 + this.rand.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreRedstone.blockID, 7)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 1; ++var13) {
			...
			var15 = this.rand.nextInt(16);
			var16 = var5 + this.rand.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreDiamond.blockID, 7)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 1; ++var13) {
			...
			var16 = var5 + this.rand.nextInt(16);
			(new WorldGenMinable(net.minecraft.block.Block.oreLapis.blockID, 6)).generate(this.worldObj, this.rand, var14, var15, var16);
		}
		...
		for(var16 = 0; var16 < var27; ++var16) {
			...
			(new net.minecraft.world.WorldGenFlowers(net.minecraft.block.Block.plantYellow.blockID)).generate(this.worldObj, this.rand, var17, var25, var19);
		}
		...
		for(var17 = 0; var17 < var28; ++var17) {
			...
			(new WorldGenTallGrass(net.minecraft.block.Block.tallGrass.blockID, var26)).generate(this.worldObj, this.rand, var19, var20, var21);
		}
		...
		for(var17 = 0; var17 < var28; ++var17) {
			...
			(new WorldGenDeadBush(net.minecraft.block.Block.deadBush.blockID)).generate(this.worldObj, this.rand, var25, var19, var20);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			var25 = this.rand.nextInt(128);
			var19 = var5 + this.rand.nextInt(16) + 8;
			(new net.minecraft.world.WorldGenFlowers(net.minecraft.block.Block.plantRed.blockID)).generate(this.worldObj, this.rand, var17, var25, var19);
		}
		...
		if(this.rand.nextInt(4) == 0) {
			...
			var25 = this.rand.nextInt(128);
			var19 = var5 + this.rand.nextInt(16) + 8;
			(new net.minecraft.world.WorldGenFlowers(net.minecraft.block.Block.mushroomBrown.blockID)).generate(this.worldObj, this.rand, var17, var25, var19);
		}
		...
		if(this.rand.nextInt(8) == 0) {
			...
			var25 = this.rand.nextInt(128);
			var19 = var5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(net.minecraft.block.Block.mushroomRed.blockID)).generate(this.worldObj, this.rand, var17, var25, var19);
		}
		...
		for(var25 = 0; var25 < 50; ++var25) {
			...
			var21 = var5 + this.rand.nextInt(16) + 8;
			(new net.minecraft.world.WorldGenLiquids(net.minecraft.block.Block.waterMoving.blockID)).generate(this.worldObj, this.rand, var19, var20, var21);
		}
		...
		for(var25 = 0; var25 < 20; ++var25) {
			...
			var21 = var5 + this.rand.nextInt(16) + 8;
			(new WorldGenLiquids(net.minecraft.block.Block.lavaMoving.blockID)).generate(this.worldObj, this.rand, var19, var20, var21);
		}
