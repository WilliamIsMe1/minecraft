...
public class ChunkProviderSky implements net.minecraft.world.IChunkProvider {
	...
	private net.minecraft.world.World field_28081_p;
					...
					for(int var31 = 0; var31 < 4; ++var31) {
						...
						for(int var42 = 0; var42 < 8; ++var42) {
							...
							for(int var51 = 0; var51 < 8; ++var51) {
								int var52 = 0;
								if(var47 > 0.0D) {
									var52 = net.minecraft.block.Block.stone.blockID;
								}
		...
		for(int var7 = 0; var7 < 16; ++var7) {
			for(int var8 = 0; var8 < 16; ++var8) {
				...
				for(int var14 = 127; var14 >= 0; --var14) {
					...
					if(var16 == 0) {
						var11 = -1;
					} else if(var16 == net.minecraft.block.Block.stone.blockID) {
						if(var11 == -1) {
							if(var10 <= 0) {
								var12 = 0;
								var13 = (byte) net.minecraft.block.Block.stone.blockID;
							}
							...
							--var11;
							var3[var15] = var13;
							if(var11 == 0 && var13 == net.minecraft.block.Block.sand.blockID) {
								var11 = this.field_28087_j.nextInt(4);
								var13 = (byte) net.minecraft.block.Block.sandStone.blockID;
							}
						}
					}
				}
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		if(this.field_28087_j.nextInt(4) == 0) {
			...
			(new net.minecraft.world.WorldGenLakes(net.minecraft.block.Block.waterStill.blockID)).generate(this.field_28081_p, this.field_28087_j, var13, var14, var15);
		}
		...
		if(this.field_28087_j.nextInt(8) == 0) {
			...
			if(var14 < 64 || this.field_28087_j.nextInt(10) == 0) {
				(new WorldGenLakes(net.minecraft.block.Block.lavaStill.blockID)).generate(this.field_28081_p, this.field_28087_j, var13, var14, var15);
			}
		}
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(128);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.dirt.blockID, 32)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 10; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(128);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.gravel.blockID, 32)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(128);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreCoal.blockID, 16)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 20; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreIron.blockID, 8)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 2; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreGold.blockID, 8)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 8; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreRedstone.blockID, 7)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 1; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(16);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new net.minecraft.world.WorldGenMinable(net.minecraft.block.Block.oreDiamond.blockID, 7)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var13 = 0; var13 < 1; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(net.minecraft.block.Block.oreLapis.blockID, 6)).generate(this.field_28081_p, this.field_28087_j, var14, var15, var16);
		}
		...
		for(var15 = 0; var15 < 2; ++var15) {
			...
			(new net.minecraft.world.WorldGenFlowers(net.minecraft.block.Block.plantYellow.blockID)).generate(this.field_28081_p, this.field_28087_j, var16, var17, var23);
		}
		...
		if(this.field_28087_j.nextInt(2) == 0) {
			...
			var17 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new net.minecraft.world.WorldGenFlowers(net.minecraft.block.Block.plantRed.blockID)).generate(this.field_28081_p, this.field_28087_j, var15, var16, var17);
		}
		...
		if(this.field_28087_j.nextInt(4) == 0) {
			...
			var16 = this.field_28087_j.nextInt(128);
			var17 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new net.minecraft.world.WorldGenFlowers(net.minecraft.block.Block.mushroomBrown.blockID)).generate(this.field_28081_p, this.field_28087_j, var15, var16, var17);
		}
		...
		if(this.field_28087_j.nextInt(8) == 0) {
			...
			var16 = this.field_28087_j.nextInt(128);
			var17 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new WorldGenFlowers(net.minecraft.block.Block.mushroomRed.blockID)).generate(this.field_28081_p, this.field_28087_j, var15, var16, var17);
		}
		...
		for(var16 = 0; var16 < 50; ++var16) {
			...
			var19 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new net.minecraft.world.WorldGenLiquids(net.minecraft.block.Block.waterMoving.blockID)).generate(this.field_28081_p, this.field_28087_j, var17, var23, var19);
		}
		...
		for(var16 = 0; var16 < 20; ++var16) {
			...
			var19 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new WorldGenLiquids(net.minecraft.block.Block.lavaMoving.blockID)).generate(this.field_28081_p, this.field_28087_j, var17, var23, var19);
		}
