	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		if(var4 >= 1 && var4 + var6 + 1 <= 128) {
				...
				for(var13 = var3 - var18; var13 <= var3 + var18 && var10; ++var13) {
					for(var14 = var5 - var18; var14 <= var5 + var18 && var10; ++var14) {
						if(var11 >= 0 && var11 < 128) {
							...
							if(var15 != 0 && var15 != net.minecraft.block.Block.leaves.blockID) {
								var10 = false;
							}
						} else {
							var10 = false;
			...
			if(!var10) {
				...
				if((var11 == net.minecraft.block.Block.grass.blockID || var11 == net.minecraft.block.Block.dirt.blockID) && var4 < 128 - var6 - 1) {
					...
					for(var13 = var4 + var6; var13 >= var4 + var7; --var13) {
						for(var14 = var3 - var18; var14 <= var3 + var18; ++var14) {
							...
							for(int var16 = var5 - var18; var16 <= var5 + var18; ++var16) {
								...
								if((Math.abs(var15) != var18 || Math.abs(var17) != var18 || var18 <= 0) && !net.minecraft.block.Block.opaqueCubeLookup[var1.getBlockId(var14, var13, var16)]) {
									var1.setBlockAndMetadata(var14, var13, var16, net.minecraft.block.Block.leaves.blockID, 1);
								}
							}
						}
					...
					for(var13 = 0; var13 < var6 - 1; ++var13) {
						...
						if(var14 == 0 || var14 == net.minecraft.block.Block.leaves.blockID) {
