...
public class WorldGenGlowStone1 extends WorldGenerator {
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		if(!var1.isAirBlock(var3, var4, var5)) {
			return false;
		} else if(var1.getBlockId(var3, var4 + 1, var5) != Block.netherrack.getBlockID()) {
			return false;
		} else {
			var1.setBlockWithNotify(var3, var4, var5, Block.glowStone.getBlockID());
			...
			for(int var6 = 0; var6 < 1500; ++var6) {
				...
				if(var1.getBlockId(var7, var8, var9) == 0) {
					...
					for(int var11 = 0; var11 < 6; ++var11) {
						...
						if(var12 == Block.glowStone.getBlockID()) {
							++var10;
						}
					}

					if(var10 == 1) {
						var1.setBlockWithNotify(var7, var8, var9, Block.glowStone.getBlockID());
					}
				}
			}
