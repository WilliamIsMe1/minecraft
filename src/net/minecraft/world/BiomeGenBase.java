...
public class BiomeGenBase {
	...
	public int color;
	public byte topBlock = (byte) net.minecraft.block.Block.grass.blockID;
	public byte fillerBlock = (byte) net.minecraft.block.Block.dirt.blockID;
	...
	public static void generateBiomeLookup() {
		...
		desert.topBlock = desert.fillerBlock = (byte) net.minecraft.block.Block.sand.blockID;
