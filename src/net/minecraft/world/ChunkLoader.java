...
public class ChunkLoader implements IChunkLoader {
	...
	public void saveChunk(net.minecraft.world.World var1, Chunk var2) throws IOException {
		...
		if(var3.exists()) {
			net.minecraft.world.WorldInfo var4 = var1.getWorldInfo();
	...
	public static void storeChunkInCompound(Chunk var0, net.minecraft.world.World var1, NBTTagCompound var2) {
		var1.checkSessionLock();
		...
		for(int var4 = 0; var4 < var0.entities.length; ++var4) {
			...
			while(var5.hasNext()) {
				net.minecraft.entity.Entity var6 = (net.minecraft.entity.Entity)var5.next();
		...
		while(var5.hasNext()) {
			net.minecraft.block.TileEntity var9 = (net.minecraft.block.TileEntity)var5.next();
			var7 = new NBTTagCompound();
	...
	public static Chunk loadChunkIntoWorldFromCompound(net.minecraft.world.World var0, NBTTagCompound var1) {
		...
		if(var10 != null) {
			for(int var11 = 0; var11 < var10.tagCount(); ++var11) {
				...
				net.minecraft.block.TileEntity var9 = TileEntity.createAndLoadEntity(var12);
				if(var9 != null) {
