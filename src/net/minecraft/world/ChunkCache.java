...
public class ChunkCache implements IBlockAccess {
	...
	public int getLightValueExt(int var1, int var2, int var3, boolean var4) {
		if(var1 >= -32000000 && var3 >= -32000000 && var1 < 32000000 && var3 <= 32000000) {
			...
			if(var4) {
				...
				if(var5 == net.minecraft.block.Block.stairSingle.blockID || var5 == net.minecraft.block.Block.tilledField.blockID || var5 == net.minecraft.block.Block.stairCompactPlanks.blockID || var5 == net.minecraft.block.Block.stairCompactCobblestone.blockID) {
	...
	public net.minecraft.block.Material getBlockMaterial(int var1, int var2, int var3) {
		...
		return var4 == 0 ? Material.air : net.minecraft.block.Block.blocksList[var4].blockMaterial;
	}
	...
	public boolean isBlockNormalCube(int var1, int var2, int var3) {
		net.minecraft.block.Block var4 = Block.blocksList[this.getBlockId(var1, var2, var3)];
