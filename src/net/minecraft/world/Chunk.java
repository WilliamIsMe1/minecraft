...
public class Chunk {
	...
	public Chunk(net.minecraft.world.World var1, int var2, int var3) {
	...
	public void generateHeightMap() {
		...
		for(int var2 = 0; var2 < 16; ++var2) {
			for(int var3 = 0; var3 < 16; ++var3) {
				...
				for(int var5 = var2 << 11 | var3 << 7; var4 > 0 && net.minecraft.block.Block.lightOpacity[this.blocks[var5 + var4 - 1] & 255] == 0; --var4) {
				}
	...
	public void func_1024_c() {
		...
		for(var2 = 0; var2 < 16; ++var2) {
			for(var3 = 0; var3 < 16; ++var3) {
				...
				int var5;
				for(var5 = var2 << 11 | var3 << 7; var4 > 0 && net.minecraft.block.Block.lightOpacity[this.blocks[var5 + var4 - 1] & 255] == 0; --var4) {
				}
				...
				if(!this.worldObj.worldProvider.hasNoSky) {
					...
					do {
						var6 -= net.minecraft.block.Block.lightOpacity[this.blocks[var5 + var7] & 255];
						if(var6 > 0) {
	...
	private void func_1003_g(int var1, int var2, int var3) {
		...
		for(int var6 = var1 << 11 | var3 << 7; var5 > 0 && net.minecraft.block.Block.lightOpacity[this.blocks[var6 + var5 - 1] & 255] == 0; --var5) {
		}
		...
		if(var5 != var4) {
			...
			for(var10 = var5; var5 > 0 && var9 > 0; this.skylightMap.setNibble(var1, var5, var3, var9)) {
				--var5;
				int var11 = net.minecraft.block.Block.lightOpacity[this.getBlockID(var1, var5, var3)];
				if(var11 == 0) {
					var11 = 1;
				}
			...
			while(var5 > 0 && net.minecraft.block.Block.lightOpacity[this.getBlockID(var1, var5 - 1, var3)] == 0) {
				--var5;
			}
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		if(var8 == var4 && this.data.getNibble(var1, var2, var3) == var5) {
			...
			if(var8 != 0 && !this.worldObj.multiplayerWorld) {
				net.minecraft.block.Block.blocksList[var8].onBlockRemoval(this.worldObj, var9, var2, var10);
			}

			this.data.setNibble(var1, var2, var3, var5);
			if(!this.worldObj.worldProvider.hasNoSky) {
				if(net.minecraft.block.Block.lightOpacity[var6 & 255] != 0) {
					if(var2 >= var7) {
			...
			this.data.setNibble(var1, var2, var3, var5);
			if(var4 != 0) {
				net.minecraft.block.Block.blocksList[var4].onBlockAdded(this.worldObj, var9, var2, var10);
			}
	...
	public boolean setBlockID(int var1, int var2, int var3, int var4) {
		...
		if(var7 == var4) {
			...
			if(var7 != 0) {
				net.minecraft.block.Block.blocksList[var7].onBlockRemoval(this.worldObj, var8, var2, var9);
			}

			this.data.setNibble(var1, var2, var3, 0);
			if(net.minecraft.block.Block.lightOpacity[var5 & 255] != 0) {
				if(var2 >= var6) {
					this.func_1003_g(var1, var2 + 1, var3);
				}
			} else if(var2 == var6 - 1) {
			...
			if(var4 != 0 && !this.worldObj.multiplayerWorld) {
				net.minecraft.block.Block.blocksList[var4].onBlockAdded(this.worldObj, var8, var2, var9);
			}
	...
	public void addEntity(net.minecraft.entity.Entity var1) {
	...
	public void removeEntity(net.minecraft.entity.Entity var1) {
		this.removeEntityAtIndex(var1, var1.chunkCoordY);
	}

	public void removeEntityAtIndex(net.minecraft.entity.Entity var1, int var2) {
		if(var2 < 0) {
			var2 = 0;
		}
	...
	public net.minecraft.block.TileEntity getChunkBlockTileEntity(int var1, int var2, int var3) {
		ChunkPosition var4 = new ChunkPosition(var1, var2, var3);
		net.minecraft.block.TileEntity var5 = (net.minecraft.block.TileEntity)this.chunkTileEntityMap.get(var4);
		if(var5 == null) {
			int var6 = this.getBlockID(var1, var2, var3);
			if(!net.minecraft.block.Block.isBlockContainer[var6]) {
				return null;
			}

			net.minecraft.block.BlockContainer var7 = (net.minecraft.block.BlockContainer) net.minecraft.block.Block.blocksList[var6];
			var7.onBlockAdded(this.worldObj, this.xPosition * 16 + var1, var2, this.zPosition * 16 + var3);
			var5 = (net.minecraft.block.TileEntity)this.chunkTileEntityMap.get(var4);
		}
	...
	public void addTileEntity(net.minecraft.block.TileEntity var1) {
	...
	public void setChunkBlockTileEntity(int var1, int var2, int var3, net.minecraft.block.TileEntity var4) {
	...
	public void removeChunkBlockTileEntity(int var1, int var2, int var3) {
		ChunkPosition var4 = new ChunkPosition(var1, var2, var3);
		if(this.isChunkLoaded) {
			net.minecraft.block.TileEntity var5 = (net.minecraft.block.TileEntity)this.chunkTileEntityMap.remove(var4);
			if(var5 != null) {
				var5.func_31005_i();
			}
		}
	...
	public void onChunkUnload() {
		...
		while(var1.hasNext()) {
			net.minecraft.block.TileEntity var2 = (TileEntity)var1.next();
			var2.func_31005_i();
		}
	...
	public void getEntitiesWithinAABBForEntity(net.minecraft.entity.Entity var1, AxisAlignedBB var2, List var3) {
		...
		for(int var6 = var4; var6 <= var5; ++var6) {
			...
			for(int var8 = 0; var8 < var7.size(); ++var8) {
				net.minecraft.entity.Entity var9 = (net.minecraft.entity.Entity)var7.get(var8);
	...
	public void getEntitiesOfTypeWithinAAAB(Class var1, AxisAlignedBB var2, List var3) {
		...
		for(int var6 = var4; var6 <= var5; ++var6) {
			...
			for(int var8 = 0; var8 < var7.size(); ++var8) {
				net.minecraft.entity.Entity var9 = (Entity)var7.get(var8);
