		...
		for(var8 = 0; var8 < 16; ++var8) {
			for(var32 = 0; var32 < 16; ++var32) {
				for(var10 = 0; var10 < 8; ++var10) {
					...
					if(var33) {
						net.minecraft.block.Material var12 = var1.getBlockMaterial(var3 + var8, var4 + var10, var5 + var32);
		...
		for(var8 = 0; var8 < 16; ++var8) {
			for(var32 = 0; var32 < 16; ++var32) {
				for(var10 = 4; var10 < 8; ++var10) {
					if(var6[(var8 * 16 + var32) * 8 + var10] && var1.getBlockId(var3 + var8, var4 + var10 - 1, var5 + var32) == net.minecraft.block.Block.dirt.blockID && var1.getSavedLightValue(EnumSkyBlock.Sky, var3 + var8, var4 + var10, var5 + var32) > 0) {
						var1.setBlock(var3 + var8, var4 + var10 - 1, var5 + var32, net.minecraft.block.Block.grass.blockID);
					}
				}
			}
		}

		if(net.minecraft.block.Block.blocksList[this.field_15235_a].blockMaterial == Material.lava) {
			for(var8 = 0; var8 < 16; ++var8) {
				for(var32 = 0; var32 < 16; ++var32) {
					for(var10 = 0; var10 < 8; ++var10) {
						var33 = !var6[(var8 * 16 + var32) * 8 + var10] && (var8 < 15 && var6[((var8 + 1) * 16 + var32) * 8 + var10] || var8 > 0 && var6[((var8 - 1) * 16 + var32) * 8 + var10] || var32 < 15 && var6[(var8 * 16 + var32 + 1) * 8 + var10] || var32 > 0 && var6[(var8 * 16 + (var32 - 1)) * 8 + var10] || var10 < 7 && var6[(var8 * 16 + var32) * 8 + var10 + 1] || var10 > 0 && var6[(var8 * 16 + var32) * 8 + (var10 - 1)]);
