...
public class ChunkProviderHell implements net.minecraft.world.IChunkProvider {
						...
						for(int var41 = 0; var41 < 4; ++var41) {
							...
							for(int var50 = 0; var50 < 4; ++var50) {
								...
								if(var11 * 8 + var30 < var5) {
									var51 = net.minecraft.block.Block.lavaStill.blockID;
								}

								if(var46 > 0.0D) {
									var51 = net.minecraft.block.Block.netherrack.blockID;
								}
	...
	public void func_4058_b(int var1, int var2, byte[] var3) {
		...
		for(int var7 = 0; var7 < 16; ++var7) {
			for(int var8 = 0; var8 < 16; ++var8) {
				...
				int var12 = -1;
				byte var13 = (byte) net.minecraft.block.Block.netherrack.blockID;
				byte var14 = (byte) net.minecraft.block.Block.netherrack.blockID;

				for(int var15 = 127; var15 >= 0; --var15) {
					int var16 = (var8 * 16 + var7) * 128 + var15;
					if(var15 >= 127 - this.hellRNG.nextInt(5)) {
						var3[var16] = (byte) net.minecraft.block.Block.bedrock.blockID;
						...
						if(var17 == 0) {
							var12 = -1;
						} else if(var17 == net.minecraft.block.Block.netherrack.blockID) {
							if(var12 == -1) {
								if(var11 <= 0) {
									var13 = 0;
									var14 = (byte) net.minecraft.block.Block.netherrack.blockID;
								} else if(var15 >= var4 - 4 && var15 <= var4 + 1) {
									var13 = (byte) net.minecraft.block.Block.netherrack.blockID;
									var14 = (byte) net.minecraft.block.Block.netherrack.blockID;
									if(var10) {
										var13 = (byte) net.minecraft.block.Block.gravel.blockID;
									}
									...
									if(var9) {
										var13 = (byte) net.minecraft.block.Block.slowSand.blockID;
									}

									if(var9) {
										var14 = (byte) net.minecraft.block.Block.slowSand.blockID;
									}
								}

								if(var15 < var4 && var13 == 0) {
									var13 = (byte) net.minecraft.block.Block.lavaStill.blockID;
								}
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		for(var6 = 0; var6 < 8; ++var6) {
			...
			(new WorldGenHellLava(net.minecraft.block.Block.lavaMoving.blockID)).generate(this.worldObj, this.hellRNG, var7, var8, var9);
		}
		...
		if(this.hellRNG.nextInt(1) == 0) {
			...
			var9 = var5 + this.hellRNG.nextInt(16) + 8;
			(new net.minecraft.world.WorldGenFlowers(net.minecraft.block.Block.mushroomBrown.blockID)).generate(this.worldObj, this.hellRNG, var7, var8, var9);
		}
