...
public class WorldClient extends World {
	...
	public void tick() {
		...
		for(var2 = 0; var2 < 10 && !this.field_1053_F.isEmpty(); ++var2) {
			net.minecraft.entity.Entity var3 = (net.minecraft.entity.Entity)this.field_1053_F.iterator().next();
	...
	public void func_712_a(int var1, net.minecraft.entity.Entity var2) {
		net.minecraft.entity.Entity var3 = this.func_709_b(var1);
		if(var3 != null) {
	...
	public net.minecraft.entity.Entity func_709_b(int var1) {
		return (net.minecraft.entity.Entity)this.field_1055_D.lookup(var1);
	}

	public net.minecraft.entity.Entity removeEntityFromWorld(int var1) {
		net.minecraft.entity.Entity var2 = (Entity)this.field_1055_D.removeObject(var1);
		if(var2 != null) {
